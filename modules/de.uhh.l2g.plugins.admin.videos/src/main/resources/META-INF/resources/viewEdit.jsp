                ...
                <aui:col>
                    ...
                    <div id="date-time-form">
                        <aui:fieldset column="true">
                            <div id="first-title">
                                <aui:input id="firsttitle" name="firsttitle" label="first-title"
                                           value="${reqVideo.title}"/>
                                <aui:button-row>
                                    <aui:button id="apply-first-title" name="apply-first-title"
                                                value="apply-first-title" onClick="applyFirstTitle();"/>
                                </aui:button-row>
                            </div>
                            <div id="date-time">
                                <aui:input id="datetimepicker" name="datetimepicker"
                                           label="select-date-time-bevor-upload"/>
                                <aui:button-row>
                                    <aui:button id="apply-date-time" name="apply-date-time" value="apply-date-time"
                    ...
                    <div>
                        <aui:fieldset column="true">
                            <div class="upload-form">
                                <label class="btn btn-primary btn-default btn-upload" id="edits-video-lable-1">
...
<script>
    ...
    $(function () {
        ...
        if (assignedCreators) {
            $("#creators").loadTemplate("#created", assignedCreators, {
                error: function (e) {
                    console.log(e);
                }
            });
    ...
    function loadUploadedFiles() {
        $.ajax({
            ...
            success: function (vars) {
                $("#uploaded-files").loadTemplate("#remove-video-file", vars, {
                    error: function (e) {
                        console.log(e);
                    }
                });
...
<script type="text/html" id="newCreator">
    <div class="<portlet:namespace/>creatorId">
        ...
        <a class="icon-large icon-remove"
           onclick="remb($(this).closest('.<portlet:namespace/>creatorId').remove())"></a>
    </div>
</script>
...
<script type="text/html" id="remove-video-file">
    <div data-id="id">
        ...
        <a class="icon-large icon-remove" onclick="deleteFile($(this).closest('div').text())"></a>
    </div>
</script>
