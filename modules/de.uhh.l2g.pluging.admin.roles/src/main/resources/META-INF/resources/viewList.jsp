...
<div class="view list user-role">
    <div class="col-md-4">
        ...
        <liferay-ui:search-container emptyResultsMessage="no-users-found" delta="10" iteratorURL="${portletURL}"
    ...
    <div class="col-md-8 edit-table">
        <liferay-ui:search-container-row className="com.liferay.portal.kernel.model.User" keyProperty="userId"
                                         modelVar="usr">
