...
<aui:form action="${updateURL}" method="post">
    <aui:fieldset helpMessage="" column="true">
        <div class="edit-user">
            ...
            <div>
               <span class="edit-label col-6">  <liferay-ui:message key="set-producer-for-institution"/></span>
            ...
            <div>
            <span class="edit-label col-6">     <liferay-ui:message key="set-admin"/></span>
                <aui:select name="isL2gAdmin" label="">
                    <c:set var="selected" value="false"/>
                    <c:if test="${admin}">
                        <c:set var="selected" value="true"/>
                    </c:if>
                    <aui:option value='0' selected="${selected}"> <liferay-ui:message key="is-not-an-admin"/>
                    </aui:option>
