	...
	public void serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		case "findVideos":
			...
			try {
				...
				String elasticsearchResults = searchManager.getAutocompleteResultArrayBySearchWord(
						PortalUtil.getCompanyId(resourceRequest), searchText, resultLimit).toString();
