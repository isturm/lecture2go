...
<aui:form action="/web/vod/l2go/-/get/0/0/0/0/0/0/0/0/" method="POST" name="submitForm">
		...
		AUI().use('autocomplete-list', 'aui-base', 'aui-io-request', 'autocomplete-filters', 'autocomplete-highlighters', function(A) {
	        ...
	        autoCompleteList.on('select',
	        		function(event) {
	        			...
	        			$('#<portlet:namespace/>submitForm').attr('action', '/web/vod/l2go/-/get/0/0/0/0/0/0/0/0/1/' + encodeURIComponent(searchWord).replace(/\./g, '%2E').replace(/%2F/g, '%252F'));
	        ...
	        A.one('#<portlet:namespace/>submitForm').on('submit',
	        		function(event) {
	        			...
	        			$('#<portlet:namespace/>submitForm').attr('action', '/web/vod/l2go/-/get/0/0/0/0/0/0/0/0/0/' + encodeURIComponent(searchWord).replace(/\./g, '%2E').replace(/%2F/g, '%252F'));
	        		}
	        );
		});	
