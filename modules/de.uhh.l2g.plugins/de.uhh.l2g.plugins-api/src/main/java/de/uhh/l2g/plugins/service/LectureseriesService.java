...
/**
 * Provides the remote service interface for Lectureseries. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Iavor Sturm
 * @see LectureseriesServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
@OSGiBeanProperties(
	property = {
		...
		"json.web.service.context.path=Lectureseries"
	},
	service = LectureseriesService.class
)
@ProviderType
@Transactional(
...
public interface LectureseriesService extends BaseService {
