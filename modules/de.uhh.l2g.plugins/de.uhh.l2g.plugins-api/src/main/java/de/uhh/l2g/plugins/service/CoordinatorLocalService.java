...
/**
 * Provides the local service interface for Coordinator. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Iavor Sturm
 * @see CoordinatorLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CoordinatorLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CoordinatorLocalServiceUtil} to access the coordinator local service. Add custom service methods to <code>de.uhh.l2g.plugins.service.impl.CoordinatorLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
