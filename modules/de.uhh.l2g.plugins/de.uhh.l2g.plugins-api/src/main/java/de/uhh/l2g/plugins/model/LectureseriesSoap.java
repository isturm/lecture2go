...
/**
 * This class is used by SOAP remote services, specifically {@link de.uhh.l2g.plugins.service.http.LectureseriesServiceSoap}.
 *
 * @author Iavor Sturm
 * @generated
 */
public class LectureseriesSoap implements Serializable {
	...
	public static LectureseriesSoap toSoapModel(Lectureseries model) {
		...
		soapModel.setLatestOpenAccessVideoId(
			model.getLatestOpenAccessVideoId());
		soapModel.setLatestVideoUploadDate(model.getLatestVideoUploadDate());
		soapModel.setLatestVideoGenerationDate(
			model.getLatestVideoGenerationDate());
	...
	public static LectureseriesSoap[] toSoapModels(List<Lectureseries> models) {
		List<LectureseriesSoap> soapModels = new ArrayList<LectureseriesSoap>(
			models.size());
