...
/**
 * The persistence utility for the lectureseries_ institution service. This utility wraps <code>de.uhh.l2g.plugins.service.persistence.impl.Lectureseries_InstitutionPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class Lectureseries_InstitutionUtil {
	 ...
	 */
	public static Map<Serializable, Lectureseries_Institution>
	...
	public static Lectureseries_Institution update(
		...
		return getPersistence().update(
			lectureseries_Institution, serviceContext);
	}
	...
	public static Lectureseries_Institution findByLectureseriesId_First(
		...
		throws de.uhh.l2g.plugins.exception.
			NoSuchLectureseries_InstitutionException {
	...
	public static Lectureseries_Institution[] findByLectureseriesId_PrevAndNext(
		...
		return getPersistence().findByLectureseriesId_PrevAndNext(
			lectureseriesInstitutionId, lectureseriesId, orderByComparator);
	}
	...
	public static Lectureseries_Institution[] findByInstitutionId_PrevAndNext(
		...
		return getPersistence().findByInstitutionId_PrevAndNext(
			lectureseriesInstitutionId, institutionId, orderByComparator);
	}
	 ...
	 * @return the matching lectureseries_ institutions
	 */
	public static List<Lectureseries_Institution>
		findByLectureseriesIdAndInstitutionId(
			long lectureseriesId, long institutionId) {

		return getPersistence().findByLectureseriesIdAndInstitutionId(
	...
	public static List<Lectureseries_Institution>
		...
		return getPersistence().findByLectureseriesIdAndInstitutionId(
			lectureseriesId, institutionId, start, end);
	}
	 ...
	 * @throws NoSuchLectureseries_InstitutionException if a matching lectureseries_ institution could not be found
	 */
	public static Lectureseries_Institution
		...
		return getPersistence().findByLectureseriesIdAndInstitutionId_First(
	...
	public static Lectureseries_Institution
		...
		return getPersistence().fetchByLectureseriesIdAndInstitutionId_First(
			lectureseriesId, institutionId, orderByComparator);
	}
	 ...
	 */
	public static Lectureseries_Institution
			findByLectureseriesIdAndInstitutionId_Last(
				long lectureseriesId, long institutionId,
				OrderByComparator<Lectureseries_Institution> orderByComparator)
		throws de.uhh.l2g.plugins.exception.
			NoSuchLectureseries_InstitutionException {

		return getPersistence().findByLectureseriesIdAndInstitutionId_Last(
			lectureseriesId, institutionId, orderByComparator);
	}
	...
	public static Lectureseries_Institution
		...
		return getPersistence().fetchByLectureseriesIdAndInstitutionId_Last(
			lectureseriesId, institutionId, orderByComparator);
	}
	...
	public static Lectureseries_Institution[]
		...
		return getPersistence().
			findByLectureseriesIdAndInstitutionId_PrevAndNext(
				lectureseriesInstitutionId, lectureseriesId, institutionId,
				orderByComparator);
	}
	...
	public static void removeByLectureseriesIdAndInstitutionId(
		...
		getPersistence().removeByLectureseriesIdAndInstitutionId(
			lectureseriesId, institutionId);
	}
	...
	public static int countByLectureseriesIdAndInstitutionId(
		...
		return getPersistence().countByLectureseriesIdAndInstitutionId(
			lectureseriesId, institutionId);
	}
	...
	public static List<Lectureseries_Institution> findByInstitutionParentId(
		...
		return getPersistence().findByInstitutionParentId(
			institutionParentId, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 */
	public static Lectureseries_Institution[]
			findByInstitutionParentId_PrevAndNext(
		...
		return getPersistence().findByInstitutionParentId_PrevAndNext(
			lectureseriesInstitutionId, institutionParentId, orderByComparator);
	}
	...
	private static ServiceTracker
		<Lectureseries_InstitutionPersistence,
		 Lectureseries_InstitutionPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			Lectureseries_InstitutionPersistence.class);

		ServiceTracker
			<Lectureseries_InstitutionPersistence,
			 Lectureseries_InstitutionPersistence> serviceTracker =
				new ServiceTracker
					<Lectureseries_InstitutionPersistence,
					 Lectureseries_InstitutionPersistence>(
						 bundle.getBundleContext(),
						 Lectureseries_InstitutionPersistence.class, null);
