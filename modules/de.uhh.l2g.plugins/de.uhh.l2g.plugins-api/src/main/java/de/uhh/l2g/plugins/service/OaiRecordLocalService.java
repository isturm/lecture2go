...
/**
 * Provides the local service interface for OaiRecord. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Iavor Sturm
 * @see OaiRecordLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OaiRecordLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OaiRecordLocalServiceUtil} to access the oai record local service. Add custom service methods to <code>de.uhh.l2g.plugins.service.impl.OaiRecordLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
