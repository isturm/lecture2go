...
public class Producer_LectureseriesSoap implements Serializable {
	...
	public static Producer_LectureseriesSoap toSoapModel(
		...
		soapModel.setProducerLectureseriesId(
			model.getProducerLectureseriesId());
	...
	public static Producer_LectureseriesSoap[] toSoapModels(
		...
		Producer_LectureseriesSoap[] soapModels =
			new Producer_LectureseriesSoap[models.length];
	...
	public static Producer_LectureseriesSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels =
				new Producer_LectureseriesSoap[models.length][models[0].length];
		}
		else {
	...
	public static Producer_LectureseriesSoap[] toSoapModels(
		...
		List<Producer_LectureseriesSoap> soapModels =
			new ArrayList<Producer_LectureseriesSoap>(models.size());
		...
		return soapModels.toArray(
			new Producer_LectureseriesSoap[soapModels.size()]);
	}
