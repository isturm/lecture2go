...
public class Video_InstitutionSoap implements Serializable {
	...
	public static Video_InstitutionSoap[] toSoapModels(
		...
		Video_InstitutionSoap[] soapModels =
			new Video_InstitutionSoap[models.length];
	...
	public static Video_InstitutionSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels =
				new Video_InstitutionSoap[models.length][models[0].length];
		}
		else {
	...
	public static Video_InstitutionSoap[] toSoapModels(
		...
		List<Video_InstitutionSoap> soapModels =
			new ArrayList<Video_InstitutionSoap>(models.size());
