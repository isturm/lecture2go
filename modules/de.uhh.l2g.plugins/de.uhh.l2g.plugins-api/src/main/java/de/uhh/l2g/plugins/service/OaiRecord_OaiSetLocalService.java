...
/**
 * Provides the local service interface for OaiRecord_OaiSet. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Iavor Sturm
 * @see OaiRecord_OaiSetLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OaiRecord_OaiSetLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OaiRecord_OaiSetLocalServiceUtil} to access the oai record_ oai set local service. Add custom service methods to <code>de.uhh.l2g.plugins.service.impl.OaiRecord_OaiSetLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
