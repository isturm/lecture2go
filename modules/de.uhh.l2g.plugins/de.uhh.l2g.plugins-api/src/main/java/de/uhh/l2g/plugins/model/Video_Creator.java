...
@ProviderType
public interface Video_Creator extends PersistedModel, Video_CreatorModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>de.uhh.l2g.plugins.model.impl.Video_CreatorImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<Video_Creator, Long>
		VIDEO_CREATOR_ID_ACCESSOR = new Accessor<Video_Creator, Long>() {
