 ...
 * <code>de.uhh.l2g.plugins.service.impl.LastvideolistLocalServiceImpl</code> and
...
public class LastvideolistLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>de.uhh.l2g.plugins.service.impl.LastvideolistLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static java.util.List<de.uhh.l2g.plugins.model.Lastvideolist>
	...
	private static ServiceTracker
		<LastvideolistLocalService, LastvideolistLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			LastvideolistLocalService.class);

		ServiceTracker<LastvideolistLocalService, LastvideolistLocalService>
			serviceTracker =
				new ServiceTracker
					<LastvideolistLocalService, LastvideolistLocalService>(
						bundle.getBundleContext(),
						LastvideolistLocalService.class, null);
