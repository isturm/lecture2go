...
public interface OfficeLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OfficeLocalServiceUtil} to access the office local service. Add custom service methods to <code>de.uhh.l2g.plugins.service.impl.OfficeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
