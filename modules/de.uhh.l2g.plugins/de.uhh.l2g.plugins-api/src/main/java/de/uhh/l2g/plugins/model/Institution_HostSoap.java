...
public class Institution_HostSoap implements Serializable {
	...
	public static Institution_HostSoap[] toSoapModels(
		...
		Institution_HostSoap[] soapModels =
			new Institution_HostSoap[models.length];
	...
	public static Institution_HostSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels =
				new Institution_HostSoap[models.length][models[0].length];
		}
		else {
	...
	public static Institution_HostSoap[] toSoapModels(
		...
		List<Institution_HostSoap> soapModels =
			new ArrayList<Institution_HostSoap>(models.size());
