...
public interface SysLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SysLocalServiceUtil} to access the sys local service. Add custom service methods to <code>de.uhh.l2g.plugins.service.impl.SysLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
