...
public class ScheduledThreadSoap implements Serializable {
	...
	public static ScheduledThreadSoap[] toSoapModels(ScheduledThread[] models) {
		ScheduledThreadSoap[] soapModels =
			new ScheduledThreadSoap[models.length];
	...
	public static ScheduledThreadSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels =
				new ScheduledThreadSoap[models.length][models[0].length];
		}
		else {
	...
	public static ScheduledThreadSoap[] toSoapModels(
		...
		List<ScheduledThreadSoap> soapModels =
			new ArrayList<ScheduledThreadSoap>(models.size());
