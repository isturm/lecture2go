...
/**
 * Provides the local service interface for Video_MediaType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Iavor Sturm
 * @see Video_MediaTypeLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface Video_MediaTypeLocalService
