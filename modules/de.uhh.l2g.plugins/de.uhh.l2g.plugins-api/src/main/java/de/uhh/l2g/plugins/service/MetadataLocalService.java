...
public interface MetadataLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MetadataLocalServiceUtil} to access the metadata local service. Add custom service methods to <code>de.uhh.l2g.plugins.service.impl.MetadataLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
