...
/**
 * Provides the local service interface for Lastvideolist. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Iavor Sturm
 * @see LastvideolistLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LastvideolistLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LastvideolistLocalServiceUtil} to access the lastvideolist local service. Add custom service methods to <code>de.uhh.l2g.plugins.service.impl.LastvideolistLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
