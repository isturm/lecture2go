...
/**
 * Provides the local service interface for Lectureseries_Creator. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Iavor Sturm
 * @see Lectureseries_CreatorLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface Lectureseries_CreatorLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Lectureseries_CreatorLocalServiceUtil} to access the lectureseries_ creator local service. Add custom service methods to <code>de.uhh.l2g.plugins.service.impl.Lectureseries_CreatorLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Lectureseries_Creator> getByCreator(Long creatorId)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Lectureseries_Creator> getByCreatorId(Long creatorId)
		throws SystemException;
