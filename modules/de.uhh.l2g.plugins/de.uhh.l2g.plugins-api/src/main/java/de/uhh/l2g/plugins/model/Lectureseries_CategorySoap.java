...
public class Lectureseries_CategorySoap implements Serializable {
	...
	public static Lectureseries_CategorySoap toSoapModel(
		...
		soapModel.setLectureseriesCategoryId(
			model.getLectureseriesCategoryId());
	...
	public static Lectureseries_CategorySoap[] toSoapModels(
		...
		Lectureseries_CategorySoap[] soapModels =
			new Lectureseries_CategorySoap[models.length];
	...
	public static Lectureseries_CategorySoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels =
				new Lectureseries_CategorySoap[models.length][models[0].length];
		}
		else {
	...
	public static Lectureseries_CategorySoap[] toSoapModels(
		...
		List<Lectureseries_CategorySoap> soapModels =
			new ArrayList<Lectureseries_CategorySoap>(models.size());
		...
		return soapModels.toArray(
			new Lectureseries_CategorySoap[soapModels.size()]);
	}
