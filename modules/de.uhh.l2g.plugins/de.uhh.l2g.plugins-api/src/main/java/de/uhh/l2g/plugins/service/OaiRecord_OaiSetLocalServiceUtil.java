 ...
 * <code>de.uhh.l2g.plugins.service.impl.OaiRecord_OaiSetLocalServiceImpl</code> and
...
public class OaiRecord_OaiSetLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>de.uhh.l2g.plugins.service.impl.OaiRecord_OaiSetLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static de.uhh.l2g.plugins.model.OaiRecord_OaiSet
		createOaiRecord_OaiSet(long oaiRecordOaiSetId) {
	 ...
	 */
	public static de.uhh.l2g.plugins.model.OaiRecord_OaiSet
			deleteOaiRecord_OaiSet(long oaiRecordOaiSetId)
	...
	public static de.uhh.l2g.plugins.model.OaiRecord_OaiSet
		fetchOaiRecord_OaiSet(long oaiRecordOaiSetId) {
	 ...
	 */
	public static java.util.List<de.uhh.l2g.plugins.model.OaiRecord_OaiSet>
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			OaiRecord_OaiSetLocalService.class);
					...
					new ServiceTracker
						<OaiRecord_OaiSetLocalService,
						 OaiRecord_OaiSetLocalService>(
							 ...
							 OaiRecord_OaiSetLocalService.class, null);
