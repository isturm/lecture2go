...
public class Lectureseries_CreatorSoap implements Serializable {
	...
	public static Lectureseries_CreatorSoap[] toSoapModels(
		...
		Lectureseries_CreatorSoap[] soapModels =
			new Lectureseries_CreatorSoap[models.length];
	...
	public static Lectureseries_CreatorSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels =
				new Lectureseries_CreatorSoap[models.length][models[0].length];
		}
		else {
	...
	public static Lectureseries_CreatorSoap[] toSoapModels(
		...
		List<Lectureseries_CreatorSoap> soapModels =
			new ArrayList<Lectureseries_CreatorSoap>(models.size());
		...
		return soapModels.toArray(
			new Lectureseries_CreatorSoap[soapModels.size()]);
	}
