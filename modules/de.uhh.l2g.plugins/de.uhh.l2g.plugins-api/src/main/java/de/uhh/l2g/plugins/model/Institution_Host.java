...
@ProviderType
public interface Institution_Host
	extends Institution_HostModel, PersistedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>de.uhh.l2g.plugins.model.impl.Institution_HostImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<Institution_Host, Long>
		INSTITUTION_HOST_ID_ACCESSOR = new Accessor<Institution_Host, Long>() {
