...
public class OaiRecord_OaiSetSoap implements Serializable {
	...
	public static OaiRecord_OaiSetSoap[] toSoapModels(
		...
		OaiRecord_OaiSetSoap[] soapModels =
			new OaiRecord_OaiSetSoap[models.length];
	...
	public static OaiRecord_OaiSetSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels =
				new OaiRecord_OaiSetSoap[models.length][models[0].length];
		}
		else {
	...
	public static OaiRecord_OaiSetSoap[] toSoapModels(
		...
		List<OaiRecord_OaiSetSoap> soapModels =
			new ArrayList<OaiRecord_OaiSetSoap>(models.size());
