...
public class Lectureseries_InstitutionSoap implements Serializable {
	...
	public static Lectureseries_InstitutionSoap toSoapModel(
		...
		Lectureseries_InstitutionSoap soapModel =
			new Lectureseries_InstitutionSoap();

		soapModel.setLectureseriesInstitutionId(
			model.getLectureseriesInstitutionId());
	...
	public static Lectureseries_InstitutionSoap[] toSoapModels(
		...
		Lectureseries_InstitutionSoap[] soapModels =
			new Lectureseries_InstitutionSoap[models.length];
	...
	public static Lectureseries_InstitutionSoap[] toSoapModels(
		...
		List<Lectureseries_InstitutionSoap> soapModels =
			new ArrayList<Lectureseries_InstitutionSoap>(models.size());
		...
		return soapModels.toArray(
			new Lectureseries_InstitutionSoap[soapModels.size()]);
	}
