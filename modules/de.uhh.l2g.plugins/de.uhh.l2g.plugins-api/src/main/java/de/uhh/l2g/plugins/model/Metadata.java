...
public interface Metadata extends MetadataModel, PersistedModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>de.uhh.l2g.plugins.model.impl.MetadataImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<Metadata, Long> METADATA_ID_ACCESSOR =
		new Accessor<Metadata, Long>() {
