...
/**
 * The persistence utility for the lectureseries_ category service. This utility wraps <code>de.uhh.l2g.plugins.service.persistence.impl.Lectureseries_CategoryPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class Lectureseries_CategoryUtil {
	 ...
	 */
	public static Map<Serializable, Lectureseries_Category> fetchByPrimaryKeys(
	...
	public static Lectureseries_Category findByLectureseries_First(
		...
		throws de.uhh.l2g.plugins.exception.
			NoSuchLectureseries_CategoryException {
	...
	public static Lectureseries_Category[] findByLectureseries_PrevAndNext(
		...
		return getPersistence().findByLectureseries_PrevAndNext(
			lectureseriesCategoryId, lectureseriesId, orderByComparator);
	}
	 ...
	 * @return the range of matching lectureseries_ categories
	 */
	public static List<Lectureseries_Category> findByCategory(
	 ...
	 * @throws NoSuchLectureseries_CategoryException if a matching lectureseries_ category could not be found
	 */
	public static Lectureseries_Category findByCategory_First(
			long categoryId,
			OrderByComparator<Lectureseries_Category> orderByComparator)
		throws de.uhh.l2g.plugins.exception.
			NoSuchLectureseries_CategoryException {
	 ...
	 * @throws NoSuchLectureseries_CategoryException if a matching lectureseries_ category could not be found
	 */
	public static Lectureseries_Category findByCategory_Last(
			long categoryId,
			OrderByComparator<Lectureseries_Category> orderByComparator)
		throws de.uhh.l2g.plugins.exception.
			NoSuchLectureseries_CategoryException {
	 ...
	 * @return the last matching lectureseries_ category, or <code>null</code> if a matching lectureseries_ category could not be found
	 */
	public static Lectureseries_Category fetchByCategory_Last(
		long categoryId,
		OrderByComparator<Lectureseries_Category> orderByComparator) {
	...
	public static Lectureseries_Category[] findByCategory_PrevAndNext(
		...
		return getPersistence().findByCategory_PrevAndNext(
			lectureseriesCategoryId, categoryId, orderByComparator);
	}
	...
	public static List<Lectureseries_Category> findByCategoryLectureseries(
		...
		return getPersistence().findByCategoryLectureseries(
	...
	public static List<Lectureseries_Category> findByCategoryLectureseries(
		...
		return getPersistence().findByCategoryLectureseries(
			categoryId, lectureseriesId, start, end);
	}
	...
	public static Lectureseries_Category findByCategoryLectureseries_First(
		...
		return getPersistence().findByCategoryLectureseries_First(
	...
	public static Lectureseries_Category fetchByCategoryLectureseries_First(
		...
		return getPersistence().fetchByCategoryLectureseries_First(
			categoryId, lectureseriesId, orderByComparator);
	}
	...
	public static Lectureseries_Category findByCategoryLectureseries_Last(
		...
		return getPersistence().findByCategoryLectureseries_Last(
			categoryId, lectureseriesId, orderByComparator);
	}
	...
	public static Lectureseries_Category fetchByCategoryLectureseries_Last(
		...
		return getPersistence().fetchByCategoryLectureseries_Last(
			categoryId, lectureseriesId, orderByComparator);
	}
	 ...
	 * @throws NoSuchLectureseries_CategoryException if a lectureseries_ category with the primary key could not be found
	 */
	public static Lectureseries_Category[]
			findByCategoryLectureseries_PrevAndNext(
				long lectureseriesCategoryId, long categoryId,
				long lectureseriesId,
				OrderByComparator<Lectureseries_Category> orderByComparator)
		throws de.uhh.l2g.plugins.exception.
		...
		return getPersistence().findByCategoryLectureseries_PrevAndNext(
			lectureseriesCategoryId, categoryId, lectureseriesId,
			orderByComparator);
	}
	 ...
	 * @param lectureseriesId the lectureseries ID
	 */
	public static void removeByCategoryLectureseries(
		long categoryId, long lectureseriesId) {

		getPersistence().removeByCategoryLectureseries(
			categoryId, lectureseriesId);
	}
	 ...
	 * @return the number of matching lectureseries_ categories
	 */
	public static int countByCategoryLectureseries(
		long categoryId, long lectureseriesId) {

		return getPersistence().countByCategoryLectureseries(
			categoryId, lectureseriesId);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			Lectureseries_CategoryPersistence.class);

		ServiceTracker
			<Lectureseries_CategoryPersistence,
			 Lectureseries_CategoryPersistence> serviceTracker =
				new ServiceTracker
					<Lectureseries_CategoryPersistence,
					 Lectureseries_CategoryPersistence>(
						 bundle.getBundleContext(),
						 Lectureseries_CategoryPersistence.class, null);
