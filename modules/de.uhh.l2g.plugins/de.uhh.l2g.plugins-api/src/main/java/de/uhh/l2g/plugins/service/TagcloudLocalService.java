...
public interface TagcloudLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TagcloudLocalServiceUtil} to access the tagcloud local service. Add custom service methods to <code>de.uhh.l2g.plugins.service.impl.TagcloudLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public void add(
			ArrayList<String> tagCloudArrayString, String className,
			Long objectId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Tagcloud getByObjectIdAndObjectClassType(
