 ...
 * <code>de.uhh.l2g.plugins.service.impl.Video_CreatorLocalServiceImpl</code> and
...
public class Video_CreatorLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>de.uhh.l2g.plugins.service.impl.Video_CreatorLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static void deleteByCreatorId(Long creatorId)
	...
	public static java.util.List<de.uhh.l2g.plugins.model.Video_Creator>
	...
	private static ServiceTracker
		<Video_CreatorLocalService, Video_CreatorLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			Video_CreatorLocalService.class);

		ServiceTracker<Video_CreatorLocalService, Video_CreatorLocalService>
			serviceTracker =
				new ServiceTracker
					<Video_CreatorLocalService, Video_CreatorLocalService>(
						bundle.getBundleContext(),
						Video_CreatorLocalService.class, null);
