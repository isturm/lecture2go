...
public interface EmployeeLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmployeeLocalServiceUtil} to access the employee local service. Add custom service methods to {@link de.uhh.l2g.plugins.service.impl.EmployeeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Employee createEmployee(int eid);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Employee deleteEmployee(int eid) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Employee fetchEmployee(int eid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Employee getEmployee(int eid) throws PortalException;
