...
public class Video_CategorySoap implements Serializable {
	...
	public static Video_CategorySoap[][] toSoapModels(
		Video_Category[][] models) {

		Video_CategorySoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels =
				new Video_CategorySoap[models.length][models[0].length];
		}
		else {
	...
	public static Video_CategorySoap[] toSoapModels(
		List<Video_Category> models) {

		List<Video_CategorySoap> soapModels = new ArrayList<Video_CategorySoap>(
			models.size());
