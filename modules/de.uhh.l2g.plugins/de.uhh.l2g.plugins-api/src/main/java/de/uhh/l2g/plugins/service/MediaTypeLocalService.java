...
/**
 * Provides the local service interface for MediaType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Iavor Sturm
 * @see MediaTypeLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MediaTypeLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MediaTypeLocalServiceUtil} to access the media type local service. Add custom service methods to <code>de.uhh.l2g.plugins.service.impl.MediaTypeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
