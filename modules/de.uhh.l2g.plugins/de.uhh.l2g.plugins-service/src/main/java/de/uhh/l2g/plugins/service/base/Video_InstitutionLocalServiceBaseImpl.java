...
import de.uhh.l2g.plugins.service.Video_InstitutionLocalService;
...
/**
 * Provides the base implementation for the video_ institution local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.Video_InstitutionLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class Video_InstitutionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, Video_InstitutionLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>Video_InstitutionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.Video_InstitutionLocalServiceUtil</code>.
	 */
	...
	@Override
	public Video_Institution addVideo_Institution(
		Video_Institution video_Institution) {

		video_Institution.setNew(true);

		return video_InstitutionPersistence.update(video_Institution);
	}
	...
	public Video_Institution createVideo_Institution(long videoInstitutionId) {
		return video_InstitutionPersistence.create(videoInstitutionId);
	}
	...
	@Override
	public Video_Institution deleteVideo_Institution(long videoInstitutionId)
		throws PortalException {

		return video_InstitutionPersistence.remove(videoInstitutionId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Video_Institution deleteVideo_Institution(
		Video_Institution video_Institution) {

		return video_InstitutionPersistence.remove(video_Institution);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Video_Institution.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return video_InstitutionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return video_InstitutionPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return video_InstitutionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return video_InstitutionPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Video_Institution fetchVideo_Institution(long videoInstitutionId) {
		return video_InstitutionPersistence.fetchByPrimaryKey(
			videoInstitutionId);
	}
	 ...
	 */
	@Override
	public Video_Institution getVideo_Institution(long videoInstitutionId)
		throws PortalException {

		return video_InstitutionPersistence.findByPrimaryKey(
			videoInstitutionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(Video_Institution.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("videoInstitutionId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Video_Institution.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return video_InstitutionLocalService.deleteVideo_Institution(
			(Video_Institution)persistedModel);
	}

	public BasePersistence<Video_Institution> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return video_InstitutionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Video_Institution> getVideo_Institutions(int start, int end) {
		return video_InstitutionPersistence.findAll(start, end);
	}
	...
	public int getVideo_InstitutionsCount() {
		return video_InstitutionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Video_Institution updateVideo_Institution(
		Video_Institution video_Institution) {
	 ...
	 */
	public Video_InstitutionLocalService getVideo_InstitutionLocalService() {
	...
	public String getOSGiServiceIdentifier() {
		return Video_InstitutionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				video_InstitutionPersistence.getDataSource();
	...
	@BeanReference(type = Video_InstitutionLocalService.class)
	protected Video_InstitutionLocalService video_InstitutionLocalService;
