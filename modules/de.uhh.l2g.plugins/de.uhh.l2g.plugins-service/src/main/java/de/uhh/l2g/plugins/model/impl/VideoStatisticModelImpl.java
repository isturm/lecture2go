 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link VideoStatisticModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link VideoStatisticImpl}.
 * </p>
 *
 * @author Iavor Sturm
...
public class VideoStatisticModelImpl extends BaseModelImpl<VideoStatistic>
	...
	static {
		TABLE_COLUMNS_MAP.put("videoStatisticId", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("groupId", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("companyId", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("createDate", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("modifiedDate", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("compareDate", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("totalVideos", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("publicVideos", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("privateVideos", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("currentTotal", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("currentPublic", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("currentPrivate", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("pubPercent", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("privPercent", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("currentPubPercent", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("currentPrivPercent", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("intervalName", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("publicDiff", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("privateDiff", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("totalDiff", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("dateDiff", Types.INTEGER);
	}
	...
	public static final long VIDEOSTATISTICID_COLUMN_BITMASK = 4L;
	...
	public void resetOriginalValues() {
		...
		videoStatisticModelImpl._setModifiedDate = false;
	...
	private static final ClassLoader _classLoader = VideoStatistic.class.getClassLoader();
