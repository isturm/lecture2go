 ...
 * in {@link de.uhh.l2g.plugins.service.impl.VideoLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
...
public abstract class VideoLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * <code>VideoLocalService</code> via injection or a
	 * <code>org.osgi.util.tracker.ServiceTracker</code> or use
	 * <code>de.uhh.l2g.plugins.service.VideoLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Video.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return videoPersistence.findWithDynamicQuery(dynamicQuery, start, end, orderByComparator);
	}
	 ...
	 */
	public void setCategoryLocalService(de.uhh.l2g.plugins.service.CategoryLocalService categoryLocalService) {
	 ...
	 */
	public void setCoordinatorLocalService(de.uhh.l2g.plugins.service.CoordinatorLocalService coordinatorLocalService) {
	 ...
	 */
	public void setCoordinatorPersistence(CoordinatorPersistence coordinatorPersistence) {
	 ...
	 */
	public void setCreatorLocalService(de.uhh.l2g.plugins.service.CreatorLocalService creatorLocalService) {
	 ...
	 */
	public void setHostLocalService(de.uhh.l2g.plugins.service.HostLocalService hostLocalService) {
	 ...
	 */
	public void setInstitutionLocalService(de.uhh.l2g.plugins.service.InstitutionLocalService institutionLocalService) {
	 ...
	 */
	public void setInstitutionPersistence(InstitutionPersistence institutionPersistence) {
	 ...
	 */
	public void setInstitution_HostPersistence(Institution_HostPersistence institution_HostPersistence) {
	 ...
	 */
	public void setLastvideolistPersistence(LastvideolistPersistence lastvideolistPersistence) {
	 ...
	 */
	public void setLectureseriesPersistence(LectureseriesPersistence lectureseriesPersistence) {
	 ...
	 *
	 * @param lectureseries_CategoryLocalService the lectureseries_ category local
	 *                                           service
	 */
	 ...
	 *
	 * @param lectureseries_CategoryPersistence the lectureseries_ category
	 *                                          persistence
	 */
	 ...
	 *
	 * @param lectureseries_CreatorLocalService the lectureseries_ creator local
	 *                                          service
	 */
	 ...
	 *
	 * @param lectureseries_CreatorPersistence the lectureseries_ creator
	 *                                         persistence
	 */
	public void setLectureseries_CreatorPersistence(Lectureseries_CreatorPersistence lectureseries_CreatorPersistence) {
	 ...
	 *
	 * @param lectureseries_InstitutionLocalService the lectureseries_ institution
	 *                                              local service
	 */
	 ...
	 *
	 * @param lectureseries_InstitutionPersistence the lectureseries_ institution
	 *                                             persistence
	 */
	 ...
	 */
	public void setLicenseLocalService(de.uhh.l2g.plugins.service.LicenseLocalService licenseLocalService) {
	 ...
	 */
	public de.uhh.l2g.plugins.service.MediaTypeLocalService getMediaTypeLocalService() {
	 ...
	 */
	public void setMediaTypeLocalService(de.uhh.l2g.plugins.service.MediaTypeLocalService mediaTypeLocalService) {
	 ...
	 */
	public void setMediaTypePersistence(MediaTypePersistence mediaTypePersistence) {
	 ...
	 */
	public void setMetadataLocalService(de.uhh.l2g.plugins.service.MetadataLocalService metadataLocalService) {
	 ...
	 */
	public void setOfficeLocalService(de.uhh.l2g.plugins.service.OfficeLocalService officeLocalService) {
	 ...
	 */
	public void setProducerLocalService(de.uhh.l2g.plugins.service.ProducerLocalService producerLocalService) {
	 ...
	 *
	 * @param producer_LectureseriesLocalService the producer_ lectureseries local
	 *                                           service
	 */
	 ...
	 *
	 * @param producer_LectureseriesPersistence the producer_ lectureseries
	 *                                          persistence
	 */
	 ...
	 */
	public void setScheduledThreadPersistence(ScheduledThreadPersistence scheduledThreadPersistence) {
	 ...
	 */
	public void setSegmentLocalService(de.uhh.l2g.plugins.service.SegmentLocalService segmentLocalService) {
	 ...
	 */
	public void setStatisticLocalService(de.uhh.l2g.plugins.service.StatisticLocalService statisticLocalService) {
	 ...
	 */
	public void setSysLocalService(de.uhh.l2g.plugins.service.SysLocalService sysLocalService) {
	 ...
	 */
	public void setTagcloudLocalService(de.uhh.l2g.plugins.service.TagcloudLocalService tagcloudLocalService) {
	 ...
	 */
	public void setTermLocalService(de.uhh.l2g.plugins.service.TermLocalService termLocalService) {
	 ...
	 */
	public void setVideo_CategoryPersistence(Video_CategoryPersistence video_CategoryPersistence) {
	 ...
	 */
	public void setVideo_CreatorPersistence(Video_CreatorPersistence video_CreatorPersistence) {
	 ...
	 */
	public void setVideo_InstitutionPersistence(Video_InstitutionPersistence video_InstitutionPersistence) {
	 ...
	 */
	public de.uhh.l2g.plugins.service.Video_MediaTypeLocalService getVideo_MediaTypeLocalService() {
	...
	public void setVideo_MediaTypeLocalService(
			de.uhh.l2g.plugins.service.Video_MediaTypeLocalService video_MediaTypeLocalService) {
	 ...
	 */
	public void setVideo_MediaTypePersistence(Video_MediaTypePersistence video_MediaTypePersistence) {
	 ...
	 */
	public void setVideohitlistPersistence(VideohitlistPersistence videohitlistPersistence) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("de.uhh.l2g.plugins.model.Video", videoLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister("de.uhh.l2g.plugins.model.Video");
	}
	...
	@BeanReference(type = de.uhh.l2g.plugins.service.MediaTypeLocalService.class)
	protected de.uhh.l2g.plugins.service.MediaTypeLocalService mediaTypeLocalService;
	...
	@BeanReference(type = de.uhh.l2g.plugins.service.Video_MediaTypeLocalService.class)
	protected de.uhh.l2g.plugins.service.Video_MediaTypeLocalService video_MediaTypeLocalService;
