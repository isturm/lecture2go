...
public class MediaTypePersistenceImpl
	...
	public List<MediaType> findByGroup(
		...
		if (useFinderCache) {
			list = (List<MediaType>)finderCache.getResult(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_MEDIATYPE_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(MediaTypeModelImpl.ORDER_BY_JPQL);
			}
	...
	public MediaType findByGroup_First(
		...
		throw new NoSuchMediaTypeException(sb.toString());
	}
	...
	protected MediaType getByGroup_PrevAndNext(
		...
		List<MediaType> list = query.list();
	...
	public int countByGroup(long groupId) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_MEDIATYPE_WHERE);
	...
	public MediaType remove(Serializable primaryKey)
		...
		catch (NoSuchMediaTypeException noSuchEntityException) {
	...
	public List<MediaType> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_MEDIATYPE);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_MEDIATYPE);
