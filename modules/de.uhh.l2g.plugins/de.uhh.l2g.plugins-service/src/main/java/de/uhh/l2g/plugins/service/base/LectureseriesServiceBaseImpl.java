...
/**
 * Provides the base implementation for the lectureseries remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.LectureseriesServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 * @see de.uhh.l2g.plugins.service.impl.LectureseriesServiceImpl
 * @generated
 */
public abstract class LectureseriesServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, LectureseriesService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LectureseriesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.LectureseriesServiceUtil</code>.
	 */
	...
	/**
	 * Returns the lectureseries remote service.
	 *
	 * @return the lectureseries remote service
	 */
	public LectureseriesService getLectureseriesService() {
		return lectureseriesService;
	}

	/**
	 * Sets the lectureseries remote service.
	 *
	 * @param lectureseriesService the lectureseries remote service
	 */
	public void setLectureseriesService(
	...
	public String getOSGiServiceIdentifier() {
		return LectureseriesService.class.getName();
	}
	...
	@BeanReference(type = LectureseriesService.class)
