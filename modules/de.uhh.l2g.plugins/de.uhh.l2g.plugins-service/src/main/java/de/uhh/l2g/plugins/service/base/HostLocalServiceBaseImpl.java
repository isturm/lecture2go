...
/**
 * Provides the base implementation for the host local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.HostLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class HostLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements HostLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HostLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.HostLocalServiceUtil</code>.
	 */
	...
	public Host addHost(Host host) {
		...
		return hostPersistence.update(host);
	}
	...
	public Host deleteHost(Host host) {
		return hostPersistence.remove(host);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Host.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return hostPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return hostPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return hostPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return hostPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return hostPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(hostLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Host.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("hostId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(hostLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Host.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("hostId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return hostLocalService.deleteHost((Host)persistedModel);
	}

	public BasePersistence<Host> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return hostPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Host> getHosts(int start, int end) {
		return hostPersistence.findAll(start, end);
	}
	...
	public int getHostsCount() {
		return hostPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"de.uhh.l2g.plugins.model.Host", hostLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HostLocalService.class.getName();
	}
