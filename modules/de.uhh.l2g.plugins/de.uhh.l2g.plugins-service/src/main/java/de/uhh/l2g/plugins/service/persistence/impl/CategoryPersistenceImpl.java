...
import de.uhh.l2g.plugins.model.impl.CategoryModelImpl;
...
public class CategoryPersistenceImpl
	 ...
	 */
	@Override
	public List<Category> findByGroup(
	...
	public Category fetchByGroup_Last(
		...
		List<Category> list = findByGroup(
	...
	public Category[] findByGroup_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroup_PrevAndNext(
				session, category, groupId, orderByComparator, true);

			array[1] = category;

			array[2] = getByGroup_PrevAndNext(
				session, category, groupId, orderByComparator, false);
	...
	protected Category getByGroup_PrevAndNext(
		Session session, Category category, long groupId,
		OrderByComparator<Category> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<Category> findByCompany(
	...
	public Category fetchByCompany_Last(
		...
		List<Category> list = findByCompany(
	...
	public Category[] findByCompany_PrevAndNext(
		...
		try {
			...
			array[0] = getByCompany_PrevAndNext(
				session, category, companyId, orderByComparator, true);

			array[1] = category;

			array[2] = getByCompany_PrevAndNext(
				session, category, companyId, orderByComparator, false);
	...
	protected Category getByCompany_PrevAndNext(
		Session session, Category category, long companyId,
		OrderByComparator<Category> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<Category> findByGroupAndCompany(
	...
	public Category findByGroupAndCompany_First(
		...
		Category category = fetchByGroupAndCompany_First(
	...
	public Category fetchByGroupAndCompany_First(
		...
		List<Category> list = findByGroupAndCompany(
	...
	public Category findByGroupAndCompany_Last(
		...
		Category category = fetchByGroupAndCompany_Last(
			groupId, companyId, orderByComparator);
	...
	public Category[] findByGroupAndCompany_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupAndCompany_PrevAndNext(
				session, category, groupId, companyId, orderByComparator, true);

			array[1] = category;

			array[2] = getByGroupAndCompany_PrevAndNext(
				session, category, groupId, companyId, orderByComparator,
				false);
	...
	protected Category getByGroupAndCompany_PrevAndNext(
		Session session, Category category, long groupId, long companyId,
		OrderByComparator<Category> orderByComparator, boolean previous) {
	...
	public void cacheResult(Category category) {
		entityCache.putResult(
			...
			category.getPrimaryKey(), category);
	...
	public Category updateImpl(Category category) {
		...
		if (!CategoryModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else if (isNew) {
			...
			args = new Object[] {
				categoryModelImpl.getGroupId(), categoryModelImpl.getCompanyId()
			};
		...
		entityCache.putResult(
			CategoryModelImpl.ENTITY_CACHE_ENABLED, CategoryImpl.class,
			category.getPrimaryKey(), category, false);
