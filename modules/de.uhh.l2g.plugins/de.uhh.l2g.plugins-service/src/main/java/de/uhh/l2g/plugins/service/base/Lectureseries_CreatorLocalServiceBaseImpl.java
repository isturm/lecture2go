...
import de.uhh.l2g.plugins.service.Lectureseries_CreatorLocalService;
...
/**
 * Provides the base implementation for the lectureseries_ creator local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.Lectureseries_CreatorLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class Lectureseries_CreatorLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, Lectureseries_CreatorLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>Lectureseries_CreatorLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.Lectureseries_CreatorLocalServiceUtil</code>.
	 */
	...
	@Override
	public Lectureseries_Creator addLectureseries_Creator(
		Lectureseries_Creator lectureseries_Creator) {

		lectureseries_Creator.setNew(true);

		return lectureseries_CreatorPersistence.update(lectureseries_Creator);
	}
	...
	public Lectureseries_Creator createLectureseries_Creator(
		long lectureseriesCreatorId) {

		return lectureseries_CreatorPersistence.create(lectureseriesCreatorId);
	}
	...
	@Override
	public Lectureseries_Creator deleteLectureseries_Creator(
			long lectureseriesCreatorId)
		throws PortalException {

		return lectureseries_CreatorPersistence.remove(lectureseriesCreatorId);
	}
	...
	public Lectureseries_Creator deleteLectureseries_Creator(
		...
		return lectureseries_CreatorPersistence.remove(lectureseries_Creator);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Lectureseries_Creator.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return lectureseries_CreatorPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return lectureseries_CreatorPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public Lectureseries_Creator fetchLectureseries_Creator(
		long lectureseriesCreatorId) {

		return lectureseries_CreatorPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public Lectureseries_Creator getLectureseries_Creator(
			long lectureseriesCreatorId)
		throws PortalException {

		return lectureseries_CreatorPersistence.findByPrimaryKey(
			lectureseriesCreatorId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(Lectureseries_Creator.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return lectureseries_CreatorLocalService.deleteLectureseries_Creator(
			(Lectureseries_Creator)persistedModel);
	}

	public BasePersistence<Lectureseries_Creator> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return lectureseries_CreatorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Lectureseries_Creator> getLectureseries_Creators(
		int start, int end) {

		return lectureseries_CreatorPersistence.findAll(start, end);
	}
	...
	public int getLectureseries_CreatorsCount() {
		return lectureseries_CreatorPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Lectureseries_Creator updateLectureseries_Creator(
		Lectureseries_Creator lectureseries_Creator) {
	 ...
	 */
	public Lectureseries_CreatorLocalService
	...
	public String getOSGiServiceIdentifier() {
		return Lectureseries_CreatorLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				lectureseries_CreatorPersistence.getDataSource();
	...
	@BeanReference(type = Lectureseries_CreatorLocalService.class)
	protected Lectureseries_CreatorLocalService
		lectureseries_CreatorLocalService;
