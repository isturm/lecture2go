...
public class StatisticPersistenceImpl
	...
	public Statistic fetchByStatisticId(
		...
		return fetchByStatisticId(statisticId);
	}
	...
	public Statistic fetchByC_G_S(
		...
		return fetchByC_G_S(companyId, groupId, statisticId);
	}
	...
	public Statistic fetchByC_G_S(
		...
		if (result == null) {
			...
			try {
				...
				finderCache.removeResult(_finderPathFetchByC_G_S, finderArgs);
	...
	public Statistic fetchByC_G_D(
		...
		return fetchByC_G_D(companyId, groupId, createDate);
	}
	...
	public Statistic fetchByC_G_D(
		...
		if (result == null) {
			...
			try {
				...
				finderCache.removeResult(_finderPathFetchByC_G_D, finderArgs);
	...
	public List<Statistic> findByGroup(
		...
		List<Statistic> list = (List<Statistic>)finderCache.getResult(
