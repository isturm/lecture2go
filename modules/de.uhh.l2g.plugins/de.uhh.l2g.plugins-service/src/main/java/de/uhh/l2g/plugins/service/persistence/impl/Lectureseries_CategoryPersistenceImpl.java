...
public class Lectureseries_CategoryPersistenceImpl
	...
	public List<Lectureseries_Category> findByLectureseries(
		...
		if (useFinderCache) {
			list = (List<Lectureseries_Category>)finderCache.getResult(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_LECTURESERIES_CATEGORY_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(Lectureseries_CategoryModelImpl.ORDER_BY_JPQL);
			}
	...
	public Lectureseries_Category findByLectureseries_First(
		...
		throw new NoSuchLectureseries_CategoryException(sb.toString());
	}
	...
	protected Lectureseries_Category getByLectureseries_PrevAndNext(
		...
		List<Lectureseries_Category> list = query.list();
	...
	public int countByLectureseries(long lectureseriesId) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_LECTURESERIES_CATEGORY_WHERE);
	...
	public List<Lectureseries_Category> findByCategoryLectureseries(
		...
		return findByCategoryLectureseries(
			categoryId, lectureseriesId, start, end, orderByComparator, true);
	}
	...
	public List<Lectureseries_Category> findByCategoryLectureseries(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Lectureseries_Category lectureseries_Category : list) {
					if ((categoryId !=
							lectureseries_Category.getCategoryId()) ||
						(lectureseriesId !=
							lectureseries_Category.getLectureseriesId())) {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_CATEGORYLECTURESERIES_CATEGORYID_2);

			sb.append(_FINDER_COLUMN_CATEGORYLECTURESERIES_LECTURESERIESID_2);
	...
	public Lectureseries_Category remove(Serializable primaryKey)
		...
		catch (NoSuchLectureseries_CategoryException noSuchEntityException) {
	...
	public List<Lectureseries_Category> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_LECTURESERIES_CATEGORY);
