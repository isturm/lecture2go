...
import de.uhh.l2g.plugins.service.Video_MediaTypeLocalService;
...
/**
 * Provides the base implementation for the video_ media type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.Video_MediaTypeLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 * @see de.uhh.l2g.plugins.service.impl.Video_MediaTypeLocalServiceImpl
 * @generated
 */
public abstract class Video_MediaTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, Video_MediaTypeLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>Video_MediaTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.Video_MediaTypeLocalServiceUtil</code>.
	 */
	...
	@Override
	public Video_MediaType addVideo_MediaType(Video_MediaType video_MediaType) {
		video_MediaType.setNew(true);

		return video_MediaTypePersistence.update(video_MediaType);
	}
	...
	public Video_MediaType createVideo_MediaType(long videoMediaTypeId) {
		return video_MediaTypePersistence.create(videoMediaTypeId);
	}
	...
	@Override
	public Video_MediaType deleteVideo_MediaType(long videoMediaTypeId)
		throws PortalException {

		return video_MediaTypePersistence.remove(videoMediaTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Video_MediaType deleteVideo_MediaType(
		Video_MediaType video_MediaType) {

		return video_MediaTypePersistence.remove(video_MediaType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Video_MediaType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return video_MediaTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return video_MediaTypePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return video_MediaTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return video_MediaTypePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Video_MediaType fetchVideo_MediaType(long videoMediaTypeId) {
		return video_MediaTypePersistence.fetchByPrimaryKey(videoMediaTypeId);
	}
	 ...
	 */
	@Override
	public Video_MediaType getVideo_MediaType(long videoMediaTypeId)
		throws PortalException {

		return video_MediaTypePersistence.findByPrimaryKey(videoMediaTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(video_MediaTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Video_MediaType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("videoMediaTypeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Video_MediaType.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return video_MediaTypeLocalService.deleteVideo_MediaType(
			(Video_MediaType)persistedModel);
	}

	public BasePersistence<Video_MediaType> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return video_MediaTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Video_MediaType> getVideo_MediaTypes(int start, int end) {
		return video_MediaTypePersistence.findAll(start, end);
	}
	...
	public int getVideo_MediaTypesCount() {
		return video_MediaTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Video_MediaType updateVideo_MediaType(
		Video_MediaType video_MediaType) {
	 ...
	 */
	public de.uhh.l2g.plugins.service.CategoryLocalService
	 ...
	 */
	public de.uhh.l2g.plugins.service.CoordinatorLocalService
		getCoordinatorLocalService() {
	...
	public void setCoordinatorLocalService(
		de.uhh.l2g.plugins.service.CoordinatorLocalService
	 ...
	 */
	public de.uhh.l2g.plugins.service.CreatorLocalService
		getCreatorLocalService() {
	 ...
	 */
	public de.uhh.l2g.plugins.service.InstitutionLocalService
		getInstitutionLocalService() {
	...
	public void setInstitutionLocalService(
		de.uhh.l2g.plugins.service.InstitutionLocalService
	 ...
	 */
	public de.uhh.l2g.plugins.service.Institution_HostLocalService
		getInstitution_HostLocalService() {
	...
	public void setInstitution_HostLocalService(
		de.uhh.l2g.plugins.service.Institution_HostLocalService
	 ...
	 */
	public de.uhh.l2g.plugins.service.LastvideolistLocalService
		getLastvideolistLocalService() {
	...
	public void setLastvideolistLocalService(
		de.uhh.l2g.plugins.service.LastvideolistLocalService
			lastvideolistLocalService) {
	 ...
	 */
	public de.uhh.l2g.plugins.service.LectureseriesLocalService
		getLectureseriesLocalService() {
	...
	public void setLectureseriesLocalService(
		de.uhh.l2g.plugins.service.LectureseriesLocalService
			lectureseriesLocalService) {
	 ...
	 */
	public void setLectureseriesFinder(
		LectureseriesFinder lectureseriesFinder) {
	 ...
	 */
	public de.uhh.l2g.plugins.service.Lectureseries_CategoryLocalService
		getLectureseries_CategoryLocalService() {
	...
	public void setLectureseries_CategoryLocalService(
		de.uhh.l2g.plugins.service.Lectureseries_CategoryLocalService
			lectureseries_CategoryLocalService) {

		this.lectureseries_CategoryLocalService =
			lectureseries_CategoryLocalService;
	}
	 ...
	 */
	public Lectureseries_CategoryPersistence
		getLectureseries_CategoryPersistence() {
	...
	public void setLectureseries_CategoryPersistence(
		...
		this.lectureseries_CategoryPersistence =
			lectureseries_CategoryPersistence;
	}
	 ...
	 */
	public de.uhh.l2g.plugins.service.Lectureseries_CreatorLocalService
		getLectureseries_CreatorLocalService() {
	...
	public void setLectureseries_CreatorLocalService(
		de.uhh.l2g.plugins.service.Lectureseries_CreatorLocalService
			lectureseries_CreatorLocalService) {

		this.lectureseries_CreatorLocalService =
			lectureseries_CreatorLocalService;
	}
	 ...
	 */
	public Lectureseries_CreatorPersistence
		getLectureseries_CreatorPersistence() {
	...
	public void setLectureseries_CreatorPersistence(
		...
		this.lectureseries_CreatorPersistence =
	 ...
	 */
	public de.uhh.l2g.plugins.service.Lectureseries_InstitutionLocalService
		getLectureseries_InstitutionLocalService() {
	...
	public void setLectureseries_InstitutionLocalService(
		de.uhh.l2g.plugins.service.Lectureseries_InstitutionLocalService
			lectureseries_InstitutionLocalService) {

		this.lectureseries_InstitutionLocalService =
			lectureseries_InstitutionLocalService;
	}
	 ...
	 */
	public Lectureseries_InstitutionPersistence
		getLectureseries_InstitutionPersistence() {
	...
	public void setLectureseries_InstitutionPersistence(
		Lectureseries_InstitutionPersistence
			lectureseries_InstitutionPersistence) {

		this.lectureseries_InstitutionPersistence =
			lectureseries_InstitutionPersistence;
	}
	 ...
	 */
	public de.uhh.l2g.plugins.service.LicenseLocalService
		getLicenseLocalService() {
	...
	/**
	 * Returns the license finder.
	 *
	 * @return the license finder
	 */
	 ...
	 */
	public de.uhh.l2g.plugins.service.MetadataLocalService
		getMetadataLocalService() {
	 ...
	 */
	public void setMetadataPersistence(
	 ...
	 */
	public de.uhh.l2g.plugins.service.OfficeLocalService
		getOfficeLocalService() {
	 ...
	 */
	public de.uhh.l2g.plugins.service.ProducerLocalService
		getProducerLocalService() {
	 ...
	 */
	public de.uhh.l2g.plugins.service.Producer_LectureseriesLocalService
		getProducer_LectureseriesLocalService() {
	...
	public void setProducer_LectureseriesLocalService(
		de.uhh.l2g.plugins.service.Producer_LectureseriesLocalService
			producer_LectureseriesLocalService) {

		this.producer_LectureseriesLocalService =
			producer_LectureseriesLocalService;
	}
	 ...
	 */
	public Producer_LectureseriesPersistence
		getProducer_LectureseriesPersistence() {
	...
	public void setProducer_LectureseriesPersistence(
		...
		this.producer_LectureseriesPersistence =
	 ...
	 */
	public de.uhh.l2g.plugins.service.ScheduledThreadLocalService
		getScheduledThreadLocalService() {
	...
	public void setScheduledThreadLocalService(
		de.uhh.l2g.plugins.service.ScheduledThreadLocalService
			scheduledThreadLocalService) {
	 ...
	 */
	public de.uhh.l2g.plugins.service.SegmentLocalService
	 ...
	 */
	public de.uhh.l2g.plugins.service.StatisticLocalService
		getStatisticLocalService() {
	...
	public void setStatisticLocalService(
		de.uhh.l2g.plugins.service.StatisticLocalService
			statisticLocalService) {
	 ...
	 */
	public de.uhh.l2g.plugins.service.TagcloudLocalService
		getTagcloudLocalService() {
	 ...
	 */
	public void setTagcloudPersistence(
		TagcloudPersistence tagcloudPersistence) {
	 ...
	 */
	public de.uhh.l2g.plugins.service.Video_CategoryLocalService
		getVideo_CategoryLocalService() {
	...
	public void setVideo_CategoryLocalService(
		de.uhh.l2g.plugins.service.Video_CategoryLocalService
			video_CategoryLocalService) {
	 ...
	 */
	public de.uhh.l2g.plugins.service.Video_CreatorLocalService
		getVideo_CreatorLocalService() {
	...
	public void setVideo_CreatorLocalService(
		de.uhh.l2g.plugins.service.Video_CreatorLocalService
			video_CreatorLocalService) {
	 ...
	 */
	public de.uhh.l2g.plugins.service.Video_InstitutionLocalService
		getVideo_InstitutionLocalService() {
	...
	public void setVideo_InstitutionLocalService(
		de.uhh.l2g.plugins.service.Video_InstitutionLocalService
	 ...
	 */
	public Video_MediaTypeLocalService getVideo_MediaTypeLocalService() {
	 ...
	 */
	public de.uhh.l2g.plugins.service.VideohitlistLocalService
		getVideohitlistLocalService() {
	...
	public void setVideohitlistLocalService(
		de.uhh.l2g.plugins.service.VideohitlistLocalService
			videohitlistLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"de.uhh.l2g.plugins.model.Video_MediaType",
			video_MediaTypeLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return Video_MediaTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = video_MediaTypePersistence.getDataSource();
	...
	protected de.uhh.l2g.plugins.service.CategoryLocalService
	...
	@BeanReference(
		type = de.uhh.l2g.plugins.service.CoordinatorLocalService.class
	)
	protected de.uhh.l2g.plugins.service.CoordinatorLocalService
		coordinatorLocalService;
	...
	protected de.uhh.l2g.plugins.service.CreatorLocalService
		creatorLocalService;
	...
	@BeanReference(
		type = de.uhh.l2g.plugins.service.InstitutionLocalService.class
	)
	protected de.uhh.l2g.plugins.service.InstitutionLocalService
		institutionLocalService;
	...
	@BeanReference(
		type = de.uhh.l2g.plugins.service.Institution_HostLocalService.class
	)
	protected de.uhh.l2g.plugins.service.Institution_HostLocalService
		institution_HostLocalService;
	...
	@BeanReference(
		type = de.uhh.l2g.plugins.service.LastvideolistLocalService.class
	)
	protected de.uhh.l2g.plugins.service.LastvideolistLocalService
		lastvideolistLocalService;
	...
	@BeanReference(
		type = de.uhh.l2g.plugins.service.LectureseriesLocalService.class
	)
	protected de.uhh.l2g.plugins.service.LectureseriesLocalService
		lectureseriesLocalService;
	...
	@BeanReference(
		type = de.uhh.l2g.plugins.service.Lectureseries_CategoryLocalService.class
	)
	protected de.uhh.l2g.plugins.service.Lectureseries_CategoryLocalService
		lectureseries_CategoryLocalService;

	@BeanReference(type = Lectureseries_CategoryPersistence.class)
	protected Lectureseries_CategoryPersistence
		lectureseries_CategoryPersistence;

	@BeanReference(
		type = de.uhh.l2g.plugins.service.Lectureseries_CreatorLocalService.class
	)
	protected de.uhh.l2g.plugins.service.Lectureseries_CreatorLocalService
		lectureseries_CreatorLocalService;
	...
	@BeanReference(
		type = de.uhh.l2g.plugins.service.Lectureseries_InstitutionLocalService.class
	)
	protected de.uhh.l2g.plugins.service.Lectureseries_InstitutionLocalService
		lectureseries_InstitutionLocalService;

	@BeanReference(type = Lectureseries_InstitutionPersistence.class)
	protected Lectureseries_InstitutionPersistence
		lectureseries_InstitutionPersistence;

	@BeanReference(type = de.uhh.l2g.plugins.service.LicenseLocalService.class)
	protected de.uhh.l2g.plugins.service.LicenseLocalService
		licenseLocalService;

	@BeanReference(type = LicensePersistence.class)
	protected LicensePersistence licensePersistence;

	@BeanReference(type = LicenseFinder.class)
	...
	protected de.uhh.l2g.plugins.service.ProducerLocalService
		producerLocalService;
	...
	@BeanReference(
		type = de.uhh.l2g.plugins.service.Producer_LectureseriesLocalService.class
	)
	protected de.uhh.l2g.plugins.service.Producer_LectureseriesLocalService
		producer_LectureseriesLocalService;

	@BeanReference(type = Producer_LectureseriesPersistence.class)
	protected Producer_LectureseriesPersistence
		producer_LectureseriesPersistence;

	@BeanReference(
		type = de.uhh.l2g.plugins.service.ScheduledThreadLocalService.class
	)
	protected de.uhh.l2g.plugins.service.ScheduledThreadLocalService
		scheduledThreadLocalService;
	...
	protected de.uhh.l2g.plugins.service.SegmentLocalService
		segmentLocalService;
	...
	@BeanReference(
		type = de.uhh.l2g.plugins.service.StatisticLocalService.class
	)
	protected de.uhh.l2g.plugins.service.StatisticLocalService
		statisticLocalService;
	...
	protected de.uhh.l2g.plugins.service.TagcloudLocalService
		tagcloudLocalService;
	...
	@BeanReference(
		type = de.uhh.l2g.plugins.service.Video_CategoryLocalService.class
	)
	protected de.uhh.l2g.plugins.service.Video_CategoryLocalService
		video_CategoryLocalService;
	...
	@BeanReference(
		type = de.uhh.l2g.plugins.service.Video_CreatorLocalService.class
	)
	protected de.uhh.l2g.plugins.service.Video_CreatorLocalService
		video_CreatorLocalService;
	...
	@BeanReference(
		type = de.uhh.l2g.plugins.service.Video_InstitutionLocalService.class
	)
	protected de.uhh.l2g.plugins.service.Video_InstitutionLocalService
		video_InstitutionLocalService;

	@BeanReference(type = Video_InstitutionPersistence.class)
	protected Video_InstitutionPersistence video_InstitutionPersistence;

	@BeanReference(type = Video_MediaTypeLocalService.class)
	protected Video_MediaTypeLocalService video_MediaTypeLocalService;
	...
	protected de.uhh.l2g.plugins.service.VideohitlistLocalService
		videohitlistLocalService;
