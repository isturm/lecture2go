...
public class TagcloudPersistenceImpl
	...
	public List<Tagcloud> findByObjectClassType(
		...
		return findByObjectClassType(
			objectClassType, start, end, orderByComparator, true);
	}
	...
	public List<Tagcloud> findByObjectClassType(
		...
		if (useFinderCache) {
			list = (List<Tagcloud>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (Tagcloud tagcloud : list) {
					if (!objectClassType.equals(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_TAGCLOUD_WHERE);

			boolean bindObjectClassType = false;

			if (objectClassType.isEmpty()) {
				sb.append(_FINDER_COLUMN_OBJECTCLASSTYPE_OBJECTCLASSTYPE_3);
			}
			else {
				bindObjectClassType = true;

				sb.append(_FINDER_COLUMN_OBJECTCLASSTYPE_OBJECTCLASSTYPE_2);
			}
			...
			if (orderByComparator != null) {
				...
				sb.append(TagcloudModelImpl.ORDER_BY_JPQL);
			}
	...
	public Tagcloud findByObjectClassType_First(
		...
		throw new NoSuchTagcloudException(sb.toString());
	}
	...
	public int countByObjectClassType(String objectClassType) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_TAGCLOUD_WHERE);
	...
	public List<Tagcloud> findByObjectId(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_OBJECTID_OBJECTID_2);
	...
	public Tagcloud fetchByObjectClassTypeAndObjectId(
		...
		return fetchByObjectClassTypeAndObjectId(
			objectClassType, objectId, true);
	}
	...
	public Tagcloud fetchByObjectClassTypeAndObjectId(
		...
		if (useFinderCache) {
			finderArgs = new Object[] {objectClassType, objectId};
		}
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_OBJECTCLASSTYPEANDOBJECTID_OBJECTID_2);
	...
	public Tagcloud remove(Serializable primaryKey)
		...
		catch (NoSuchTagcloudException noSuchEntityException) {
	...
	public List<Tagcloud> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_TAGCLOUD);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_TAGCLOUD);
