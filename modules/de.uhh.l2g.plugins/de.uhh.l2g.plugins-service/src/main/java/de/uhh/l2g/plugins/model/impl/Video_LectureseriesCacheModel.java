...
public class Video_LectureseriesCacheModel implements CacheModel<Video_Lectureseries>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof Video_LectureseriesCacheModel)) {
			return false;
		}

		Video_LectureseriesCacheModel video_LectureseriesCacheModel = (Video_LectureseriesCacheModel)obj;

		if (videoLectureseriesId == video_LectureseriesCacheModel.videoLectureseriesId) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, videoLectureseriesId);
	}
