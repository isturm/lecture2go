 ...
 * @generated
 */
public class OaiRecordCacheModel
	implements CacheModel<OaiRecord>, Externalizable {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof OaiRecordCacheModel)) {
			return false;
		}

		OaiRecordCacheModel oaiRecordCacheModel = (OaiRecordCacheModel)object;

		if (oaiRecordId == oaiRecordCacheModel.oaiRecordId) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, oaiRecordId);
	}
