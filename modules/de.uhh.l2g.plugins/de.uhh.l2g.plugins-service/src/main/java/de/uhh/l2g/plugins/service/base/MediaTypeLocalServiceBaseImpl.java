...
import de.uhh.l2g.plugins.service.MediaTypeLocalService;
...
/**
 * Provides the base implementation for the media type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.MediaTypeLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 * @see de.uhh.l2g.plugins.service.impl.MediaTypeLocalServiceImpl
 * @generated
 */
public abstract class MediaTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, MediaTypeLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MediaTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.MediaTypeLocalServiceUtil</code>.
	 */
	...
	public MediaType addMediaType(MediaType mediaType) {
		...
		return mediaTypePersistence.update(mediaType);
	}
	...
	public MediaType createMediaType(long mediaTypeId) {
		return mediaTypePersistence.create(mediaTypeId);
	}
	...
	@Override
	public MediaType deleteMediaType(long mediaTypeId) throws PortalException {
		return mediaTypePersistence.remove(mediaTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MediaType deleteMediaType(MediaType mediaType) {
		return mediaTypePersistence.remove(mediaType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MediaType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return mediaTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return mediaTypePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return mediaTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return mediaTypePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MediaType fetchMediaType(long mediaTypeId) {
		return mediaTypePersistence.fetchByPrimaryKey(mediaTypeId);
	}
	 ...
	 */
	@Override
	public MediaType getMediaType(long mediaTypeId) throws PortalException {
		return mediaTypePersistence.findByPrimaryKey(mediaTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(mediaTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MediaType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("mediaTypeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(MediaType.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return mediaTypeLocalService.deleteMediaType((MediaType)persistedModel);
	}

	public BasePersistence<MediaType> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return mediaTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MediaType> getMediaTypes(int start, int end) {
		return mediaTypePersistence.findAll(start, end);
	}
	...
	public int getMediaTypesCount() {
		return mediaTypePersistence.countAll();
	}
	 ...
	 */
	public MediaTypeLocalService getMediaTypeLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"de.uhh.l2g.plugins.model.MediaType", mediaTypeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"de.uhh.l2g.plugins.model.MediaType");
	}
	...
	public String getOSGiServiceIdentifier() {
		return MediaTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = mediaTypePersistence.getDataSource();
	...
	@BeanReference(type = MediaTypeLocalService.class)
	protected MediaTypeLocalService mediaTypeLocalService;
