...
import de.uhh.l2g.plugins.service.VideohitlistLocalService;
...
/**
 * Provides the base implementation for the videohitlist local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.VideohitlistLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class VideohitlistLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, VideohitlistLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>VideohitlistLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.VideohitlistLocalServiceUtil</code>.
	 */
	...
	public Videohitlist addVideohitlist(Videohitlist videohitlist) {
		...
		return videohitlistPersistence.update(videohitlist);
	}
	...
	public Videohitlist deleteVideohitlist(Videohitlist videohitlist) {
		return videohitlistPersistence.remove(videohitlist);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Videohitlist.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return videohitlistPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return videohitlistPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return videohitlistPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return videohitlistPersistence.countWithDynamicQuery(
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(videohitlistLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Videohitlist.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("videohitlistId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Videohitlist.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return videohitlistLocalService.deleteVideohitlist(
			(Videohitlist)persistedModel);
	}

	public BasePersistence<Videohitlist> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return videohitlistPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Videohitlist> getVideohitlists(int start, int end) {
		return videohitlistPersistence.findAll(start, end);
	}
	...
	public int getVideohitlistsCount() {
		return videohitlistPersistence.countAll();
	}
	 ...
	 */
	public VideohitlistLocalService getVideohitlistLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"de.uhh.l2g.plugins.model.Videohitlist", videohitlistLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return VideohitlistLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = videohitlistPersistence.getDataSource();
	...
	@BeanReference(type = VideohitlistLocalService.class)
	protected VideohitlistLocalService videohitlistLocalService;
