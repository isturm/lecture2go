 ...
 * @generated
 */
public class OaiRecord_OaiSetCacheModel
	implements CacheModel<OaiRecord_OaiSet>, Externalizable {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof OaiRecord_OaiSetCacheModel)) {
			return false;
		}

		OaiRecord_OaiSetCacheModel oaiRecord_OaiSetCacheModel =
			(OaiRecord_OaiSetCacheModel)object;

		if (oaiRecordOaiSetId == oaiRecord_OaiSetCacheModel.oaiRecordOaiSetId) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, oaiRecordOaiSetId);
	}
