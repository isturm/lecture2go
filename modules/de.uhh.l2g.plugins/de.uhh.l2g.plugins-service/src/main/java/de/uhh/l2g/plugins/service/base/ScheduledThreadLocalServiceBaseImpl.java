...
import de.uhh.l2g.plugins.service.ScheduledThreadLocalService;
...
/**
 * Provides the base implementation for the scheduled thread local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.ScheduledThreadLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class ScheduledThreadLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, ScheduledThreadLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ScheduledThreadLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.ScheduledThreadLocalServiceUtil</code>.
	 */
	...
	public ScheduledThread addScheduledThread(ScheduledThread scheduledThread) {
		...
		return scheduledThreadPersistence.update(scheduledThread);
	}
	...
	public ScheduledThread createScheduledThread(long scheduledThreadId) {
		return scheduledThreadPersistence.create(scheduledThreadId);
	}
	...
	@Override
	public ScheduledThread deleteScheduledThread(long scheduledThreadId)
		throws PortalException {

		return scheduledThreadPersistence.remove(scheduledThreadId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ScheduledThread deleteScheduledThread(
		ScheduledThread scheduledThread) {

		return scheduledThreadPersistence.remove(scheduledThread);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ScheduledThread.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return scheduledThreadPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return scheduledThreadPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return scheduledThreadPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return scheduledThreadPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ScheduledThread fetchScheduledThread(long scheduledThreadId) {
		return scheduledThreadPersistence.fetchByPrimaryKey(scheduledThreadId);
	}
	 ...
	 */
	@Override
	public ScheduledThread getScheduledThread(long scheduledThreadId)
		throws PortalException {

		return scheduledThreadPersistence.findByPrimaryKey(scheduledThreadId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(scheduledThreadLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ScheduledThread.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("scheduledThreadId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(ScheduledThread.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return scheduledThreadLocalService.deleteScheduledThread(
			(ScheduledThread)persistedModel);
	}

	public BasePersistence<ScheduledThread> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return scheduledThreadPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ScheduledThread> getScheduledThreads(int start, int end) {
		return scheduledThreadPersistence.findAll(start, end);
	}
	...
	public int getScheduledThreadsCount() {
		return scheduledThreadPersistence.countAll();
	}
	 ...
	 */
	public ScheduledThreadLocalService getScheduledThreadLocalService() {
	...
	public String getOSGiServiceIdentifier() {
		return ScheduledThreadLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = scheduledThreadPersistence.getDataSource();
	...
	@BeanReference(type = ScheduledThreadLocalService.class)
	protected ScheduledThreadLocalService scheduledThreadLocalService;
