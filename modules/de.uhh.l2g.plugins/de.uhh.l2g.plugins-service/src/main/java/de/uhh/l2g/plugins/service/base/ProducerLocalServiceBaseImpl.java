...
/**
 * Provides the base implementation for the producer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.ProducerLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
...
public abstract class ProducerLocalServiceBaseImpl
	...
	implements IdentifiableOSGiService, ProducerLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProducerLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.ProducerLocalServiceUtil</code>.
	 */
	...
	public Producer addProducer(Producer producer) {
		...
		return producerPersistence.update(producer);
	}
	...
	public Producer createProducer(long producerId) {
		return producerPersistence.create(producerId);
	}
	...
	public Producer deleteProducer(long producerId) throws PortalException {
		return producerPersistence.remove(producerId);
	}
	...
	public Producer deleteProducer(Producer producer) {
		return producerPersistence.remove(producer);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Producer.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return producerPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return producerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return producerPersistence.countWithDynamicQuery(
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(producerLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Producer.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("producerId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Producer.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("producerId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return producerLocalService.deleteProducer((Producer)persistedModel);
	}

	public BasePersistence<Producer> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return producerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"de.uhh.l2g.plugins.model.Producer", producerLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProducerLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = producerPersistence.getDataSource();
	...
	@BeanReference(type = ProducerLocalService.class)
