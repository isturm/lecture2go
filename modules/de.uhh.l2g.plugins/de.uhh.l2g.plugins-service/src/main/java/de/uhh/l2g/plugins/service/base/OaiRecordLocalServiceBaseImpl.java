...
import de.uhh.l2g.plugins.service.OaiRecordLocalService;
...
/**
 * Provides the base implementation for the oai record local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.OaiRecordLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class OaiRecordLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, OaiRecordLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OaiRecordLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.OaiRecordLocalServiceUtil</code>.
	 */
	...
	public OaiRecord addOaiRecord(OaiRecord oaiRecord) {
		...
		return oaiRecordPersistence.update(oaiRecord);
	}
	...
	public OaiRecord createOaiRecord(long oaiRecordId) {
		return oaiRecordPersistence.create(oaiRecordId);
	}
	...
	@Override
	public OaiRecord deleteOaiRecord(long oaiRecordId) throws PortalException {
		return oaiRecordPersistence.remove(oaiRecordId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public OaiRecord deleteOaiRecord(OaiRecord oaiRecord) {
		return oaiRecordPersistence.remove(oaiRecord);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OaiRecord.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return oaiRecordPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return oaiRecordPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return oaiRecordPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return oaiRecordPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public OaiRecord fetchOaiRecord(long oaiRecordId) {
		return oaiRecordPersistence.fetchByPrimaryKey(oaiRecordId);
	}
	 ...
	 */
	@Override
	public OaiRecord getOaiRecord(long oaiRecordId) throws PortalException {
		return oaiRecordPersistence.findByPrimaryKey(oaiRecordId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(oaiRecordLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(OaiRecord.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("oaiRecordId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(OaiRecord.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return oaiRecordLocalService.deleteOaiRecord((OaiRecord)persistedModel);
	}

	public BasePersistence<OaiRecord> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return oaiRecordPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<OaiRecord> getOaiRecords(int start, int end) {
		return oaiRecordPersistence.findAll(start, end);
	}
	...
	public int getOaiRecordsCount() {
		return oaiRecordPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OaiRecord updateOaiRecord(OaiRecord oaiRecord) {
		return oaiRecordPersistence.update(oaiRecord);
	}
	 ...
	 */
	public OaiRecordLocalService getOaiRecordLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"de.uhh.l2g.plugins.model.OaiRecord", oaiRecordLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"de.uhh.l2g.plugins.model.OaiRecord");
	}
	...
	public String getOSGiServiceIdentifier() {
		return OaiRecordLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = oaiRecordPersistence.getDataSource();
	...
	@BeanReference(type = OaiRecordLocalService.class)
	protected OaiRecordLocalService oaiRecordLocalService;
