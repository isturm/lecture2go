...
public class ProducerLocalServiceImpl extends ProducerLocalServiceBaseImpl {
	...
	public List<Long> getAllProducerIds(Long lectureseriesId)throws SystemException{
		List<Long> pIds = producerFinder.findProducerIds(lectureseriesId, com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS, com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS);
		return pIds;
	}

	public List<Long> getProducerIds(Long lectureseriesId, int begin, int end)throws SystemException{
		List<Long> pIds = producerFinder.findProducerIds(lectureseriesId, begin, end);
		return pIds;
	}
