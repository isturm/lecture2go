...
import de.uhh.l2g.plugins.service.Video_CategoryLocalService;
...
/**
 * Provides the base implementation for the video_ category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.Video_CategoryLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class Video_CategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, Video_CategoryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>Video_CategoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.Video_CategoryLocalServiceUtil</code>.
	 */
	...
	public Video_Category addVideo_Category(Video_Category video_Category) {
		...
		return video_CategoryPersistence.update(video_Category);
	}
	...
	public Video_Category createVideo_Category(long videoCategoryId) {
		return video_CategoryPersistence.create(videoCategoryId);
	}
	...
	public Video_Category deleteVideo_Category(long videoCategoryId)
		...
		return video_CategoryPersistence.remove(videoCategoryId);
	}
	...
	public Video_Category deleteVideo_Category(Video_Category video_Category) {
		return video_CategoryPersistence.remove(video_Category);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Video_Category.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return video_CategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return video_CategoryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return video_CategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return video_CategoryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Video_Category fetchVideo_Category(long videoCategoryId) {
		return video_CategoryPersistence.fetchByPrimaryKey(videoCategoryId);
	}
	...
	public Video_Category getVideo_Category(long videoCategoryId)
		...
		return video_CategoryPersistence.findByPrimaryKey(videoCategoryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(video_CategoryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Video_Category.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("videoCategoryId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Video_Category.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return video_CategoryLocalService.deleteVideo_Category(
			(Video_Category)persistedModel);
	}

	public BasePersistence<Video_Category> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return video_CategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Video_Category> getVideo_Categories(int start, int end) {
		return video_CategoryPersistence.findAll(start, end);
	}
	...
	public int getVideo_CategoriesCount() {
		return video_CategoryPersistence.countAll();
	}
	 ...
	 */
	public Video_CategoryLocalService getVideo_CategoryLocalService() {
	...
	public String getOSGiServiceIdentifier() {
		return Video_CategoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = video_CategoryPersistence.getDataSource();
	...
	@BeanReference(type = Video_CategoryLocalService.class)
	protected Video_CategoryLocalService video_CategoryLocalService;
