...
import de.uhh.l2g.plugins.service.OaiSetLocalService;
...
/**
 * Provides the base implementation for the oai set local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.OaiSetLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class OaiSetLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, OaiSetLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OaiSetLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.OaiSetLocalServiceUtil</code>.
	 */
	...
	public OaiSet addOaiSet(OaiSet oaiSet) {
		...
		return oaiSetPersistence.update(oaiSet);
	}
	...
	public OaiSet createOaiSet(long oaiSetId) {
		return oaiSetPersistence.create(oaiSetId);
	}
	...
	public OaiSet deleteOaiSet(long oaiSetId) throws PortalException {
		return oaiSetPersistence.remove(oaiSetId);
	}
	...
	public OaiSet deleteOaiSet(OaiSet oaiSet) {
		return oaiSetPersistence.remove(oaiSet);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OaiSet.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return oaiSetPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return oaiSetPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return oaiSetPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return oaiSetPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return oaiSetPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public OaiSet fetchOaiSet(long oaiSetId) {
		return oaiSetPersistence.fetchByPrimaryKey(oaiSetId);
	}
	...
	public OaiSet getOaiSet(long oaiSetId) throws PortalException {
		return oaiSetPersistence.findByPrimaryKey(oaiSetId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(oaiSetLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(OaiSet.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("oaiSetId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(oaiSetLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(OaiSet.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("oaiSetId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return oaiSetLocalService.deleteOaiSet((OaiSet)persistedModel);
	}

	public BasePersistence<OaiSet> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return oaiSetPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<OaiSet> getOaiSets(int start, int end) {
		return oaiSetPersistence.findAll(start, end);
	}
	...
	public int getOaiSetsCount() {
		return oaiSetPersistence.countAll();
	}
	 ...
	 */
	public OaiSetLocalService getOaiSetLocalService() {
	 ...
	 */
	public void setOaiSetLocalService(OaiSetLocalService oaiSetLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"de.uhh.l2g.plugins.model.OaiSet", oaiSetLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return OaiSetLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = oaiSetPersistence.getDataSource();
	...
	@BeanReference(type = OaiSetLocalService.class)
	protected OaiSetLocalService oaiSetLocalService;
