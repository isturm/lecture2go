...
public abstract class CoordinatorLocalServiceBaseImpl
	...
	implements CoordinatorLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CoordinatorLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.CoordinatorLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Coordinator.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return coordinatorPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return coordinatorPersistence.countWithDynamicQuery(
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(coordinatorLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Coordinator.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("coordinatorId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Coordinator.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return coordinatorLocalService.deleteCoordinator(
			(Coordinator)persistedModel);
	}

	public BasePersistence<Coordinator> getBasePersistence() {
	 ...
	 */
	public CoordinatorLocalService getCoordinatorLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"de.uhh.l2g.plugins.model.Coordinator", coordinatorLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CoordinatorLocalService.class.getName();
	}
	...
	@BeanReference(type = CoordinatorLocalService.class)
	protected CoordinatorLocalService coordinatorLocalService;
