...
public abstract class VideoStatisticLocalServiceBaseImpl
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(videoStatisticLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VideoStatistic.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("videoStatisticId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(videoStatisticLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VideoStatistic.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return videoStatisticLocalService.deleteVideoStatistic((VideoStatistic)persistedModel);
	}
	 ...
	 */
	public VideoStatisticLocalService getVideoStatisticLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("de.uhh.l2g.plugins.model.VideoStatistic",
	...
	public String getOSGiServiceIdentifier() {
		return VideoStatisticLocalService.class.getName();
	}
	...
	@BeanReference(type = VideoStatisticLocalService.class)
