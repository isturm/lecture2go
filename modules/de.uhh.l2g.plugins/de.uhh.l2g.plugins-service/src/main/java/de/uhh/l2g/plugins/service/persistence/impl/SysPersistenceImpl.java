 ...
 * @generated
 */
public class SysPersistenceImpl
	extends BasePersistenceImpl<Sys> implements SysPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>SysUtil</code> to access the sys persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		SysImpl.class.getName();
	...
	public Sys remove(Serializable primaryKey) throws NoSuchSysException {
		...
		try {
			...
			if (sys == null) {
				...
				throw new NoSuchSysException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(sys);
		}
		catch (NoSuchSysException noSuchEntityException) {
	...
	/**
	 * Returns the sys with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the sys
	 * @return the sys
	 * @throws NoSuchSysException if a sys with the primary key could not be found
	...
	public List<Sys> findAll(
		...
		if (useFinderCache) {
			list = (List<Sys>)finderCache.getResult(
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_SYS);
	...
	public void afterPropertiesSet() {
		_finderPathWithPaginationFindAll = new FinderPath(
			SysModelImpl.ENTITY_CACHE_ENABLED,
	...
	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No Sys exists with the primary key ";

	private static final Log _log = LogFactoryUtil.getLog(
		SysPersistenceImpl.class);
