...
public class CoordinatorPersistenceImpl
	...
	public Coordinator findByInstitution(long institutionId)
		...
		if (coordinator == null) {
			...
			throw new NoSuchCoordinatorException(sb.toString());
		}
	...
	public Coordinator fetchByInstitution(
		...
		if (result == null) {
			...
			sb.append(_SQL_SELECT_COORDINATOR_WHERE);
			...
			try {
				...
				List<Coordinator> list = query.list();
	...
	public int countByInstitution(long institutionId) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_COORDINATOR_WHERE);
	...
	public List<Coordinator> findByOffice(
		...
		if (useFinderCache) {
			list = (List<Coordinator>)finderCache.getResult(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(CoordinatorModelImpl.ORDER_BY_JPQL);
			}
	...
	public Coordinator remove(Serializable primaryKey)
		...
		catch (NoSuchCoordinatorException noSuchEntityException) {
	...
	public List<Coordinator> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_COORDINATOR);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_COORDINATOR);
