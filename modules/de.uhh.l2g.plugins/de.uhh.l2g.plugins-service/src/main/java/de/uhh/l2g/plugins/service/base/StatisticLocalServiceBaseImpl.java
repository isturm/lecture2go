...
import de.uhh.l2g.plugins.service.StatisticLocalService;
...
/**
 * Provides the base implementation for the statistic local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.StatisticLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class StatisticLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, StatisticLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StatisticLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.StatisticLocalServiceUtil</code>.
	 */
	...
	public Statistic addStatistic(Statistic statistic) {
		...
		return statisticPersistence.update(statistic);
	}
	...
	public Statistic createStatistic(long statisticId) {
		return statisticPersistence.create(statisticId);
	}
	...
	public Statistic deleteStatistic(long statisticId) throws PortalException {
		return statisticPersistence.remove(statisticId);
	}
	...
	public Statistic deleteStatistic(Statistic statistic) {
		return statisticPersistence.remove(statistic);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Statistic.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return statisticPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return statisticPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return statisticPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return statisticPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Statistic fetchStatistic(long statisticId) {
		return statisticPersistence.fetchByPrimaryKey(statisticId);
	}
	...
	public Statistic getStatistic(long statisticId) throws PortalException {
		return statisticPersistence.findByPrimaryKey(statisticId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(statisticLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Statistic.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("statisticId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Statistic.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return statisticLocalService.deleteStatistic((Statistic)persistedModel);
	}

	public BasePersistence<Statistic> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return statisticPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Statistic> getStatistics(int start, int end) {
		return statisticPersistence.findAll(start, end);
	}
	...
	public int getStatisticsCount() {
		return statisticPersistence.countAll();
	}
	 ...
	 */
	public StatisticLocalService getStatisticLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"de.uhh.l2g.plugins.model.Statistic", statisticLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return StatisticLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = statisticPersistence.getDataSource();
	...
	@BeanReference(type = StatisticLocalService.class)
	protected StatisticLocalService statisticLocalService;
