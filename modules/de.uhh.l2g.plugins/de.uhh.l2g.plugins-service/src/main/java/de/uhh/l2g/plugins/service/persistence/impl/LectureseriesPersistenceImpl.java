...
public class LectureseriesPersistenceImpl
	...
	public List<Lectureseries> findByTerm(
		...
		if (useFinderCache) {
			list = (List<Lectureseries>)finderCache.getResult(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_LECTURESERIES_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(LectureseriesModelImpl.ORDER_BY_JPQL);
			}
	...
	public Lectureseries findByTerm_First(
		...
		throw new NoSuchLectureseriesException(sb.toString());
	}
	...
	protected Lectureseries getByTerm_PrevAndNext(
		...
		List<Lectureseries> list = query.list();
	...
	public int countByTerm(long termId) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_LECTURESERIES_WHERE);
	...
	public List<Lectureseries> findByType(
		...
		if (list == null) {
			...
			try {
				...
				if (bindEventType) {
					queryPos.add(StringUtil.toLowerCase(eventType));
				}
	...
	public List<Lectureseries> findByFaculty(
		...
		if (list == null) {
			...
			if (facultyName.isEmpty()) {
				sb.append(_FINDER_COLUMN_FACULTY_FACULTYNAME_3);
			}
			else {
				bindFacultyName = true;

				sb.append(_FINDER_COLUMN_FACULTY_FACULTYNAME_2);
			}
	...
	public List<Lectureseries> findByApproved(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_APPROVED_APPROVED_2);
	...
	public List<Lectureseries> findByLatestOpenAccessVideo(
		...
		return findByLatestOpenAccessVideo(
			latestOpenAccessVideoId, start, end, orderByComparator, true);
	}
	...
	public List<Lectureseries> findByLatestOpenAccessVideo(
		...
		if (list == null) {
			...
			try {
				...
				queryPos.add(latestOpenAccessVideoId);
	...
	public List<Lectureseries> findByLatestVideoUploadDate(
		...
		return findByLatestVideoUploadDate(
			latestVideoUploadDate, start, end, orderByComparator, true);
	}
		...
		if (list == null) {
			...
			try {
				...
				if (bindLatestVideoUploadDate) {
					queryPos.add(
						new Timestamp(latestVideoUploadDate.getTime()));
				}
	...
	protected Lectureseries getByLatestVideoUploadDate_PrevAndNext(
		...
		if (bindLatestVideoUploadDate) {
			queryPos.add(new Timestamp(latestVideoUploadDate.getTime()));
		}
	...
	public List<Lectureseries> findByLatestVideoGenerationDate(
		...
		return findByLatestVideoGenerationDate(
			latestVideoGenerationDate, start, end, orderByComparator, true);
	}
		...
		if (list == null) {
			...
			try {
				...
				if (bindLatestVideoGenerationDate) {
					queryPos.add(latestVideoGenerationDate);
				}
	...
	public List<Lectureseries> findByUSID(
		...
		if (list == null) {
			...
			if (USID.isEmpty()) {
				sb.append(_FINDER_COLUMN_USID_USID_3);
			}
			else {
				bindUSID = true;

				sb.append(_FINDER_COLUMN_USID_USID_2);
			}
	...
	public Lectureseries remove(Serializable primaryKey)
		...
		catch (NoSuchLectureseriesException noSuchEntityException) {
	...
	public List<Lectureseries> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_LECTURESERIES);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_LECTURESERIES);
