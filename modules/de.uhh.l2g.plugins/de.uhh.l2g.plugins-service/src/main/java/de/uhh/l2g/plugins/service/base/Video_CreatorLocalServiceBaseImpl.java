...
import de.uhh.l2g.plugins.service.Video_CreatorLocalService;
...
/**
 * Provides the base implementation for the video_ creator local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.Video_CreatorLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class Video_CreatorLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, Video_CreatorLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>Video_CreatorLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.Video_CreatorLocalServiceUtil</code>.
	 */
	...
	public Video_Creator addVideo_Creator(Video_Creator video_Creator) {
		...
		return video_CreatorPersistence.update(video_Creator);
	}
	...
	public Video_Creator createVideo_Creator(long videoCreatorId) {
		return video_CreatorPersistence.create(videoCreatorId);
	}
	...
	public Video_Creator deleteVideo_Creator(long videoCreatorId)
		...
		return video_CreatorPersistence.remove(videoCreatorId);
	}
	...
	public Video_Creator deleteVideo_Creator(Video_Creator video_Creator) {
		return video_CreatorPersistence.remove(video_Creator);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Video_Creator.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return video_CreatorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return video_CreatorPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return video_CreatorPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return video_CreatorPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Video_Creator fetchVideo_Creator(long videoCreatorId) {
		return video_CreatorPersistence.fetchByPrimaryKey(videoCreatorId);
	}
	...
	public Video_Creator getVideo_Creator(long videoCreatorId)
		...
		return video_CreatorPersistence.findByPrimaryKey(videoCreatorId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(video_CreatorLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Video_Creator.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("videoCreatorId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Video_Creator.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return video_CreatorLocalService.deleteVideo_Creator(
			(Video_Creator)persistedModel);
	}

	public BasePersistence<Video_Creator> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return video_CreatorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Video_Creator> getVideo_Creators(int start, int end) {
		return video_CreatorPersistence.findAll(start, end);
	}
	...
	public int getVideo_CreatorsCount() {
		return video_CreatorPersistence.countAll();
	}
	 ...
	 */
	public Video_CreatorLocalService getVideo_CreatorLocalService() {
	...
	public String getOSGiServiceIdentifier() {
		return Video_CreatorLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = video_CreatorPersistence.getDataSource();
	...
	@BeanReference(type = Video_CreatorLocalService.class)
	protected Video_CreatorLocalService video_CreatorLocalService;
