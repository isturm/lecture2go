...
import de.uhh.l2g.plugins.service.OaiRecord_OaiSetLocalService;
...
/**
 * Provides the base implementation for the oai record_ oai set local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.OaiRecord_OaiSetLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class OaiRecord_OaiSetLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, OaiRecord_OaiSetLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OaiRecord_OaiSetLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.OaiRecord_OaiSetLocalServiceUtil</code>.
	 */
	...
	@Override
	public OaiRecord_OaiSet addOaiRecord_OaiSet(
		OaiRecord_OaiSet oaiRecord_OaiSet) {

		oaiRecord_OaiSet.setNew(true);

		return oaiRecord_OaiSetPersistence.update(oaiRecord_OaiSet);
	}
	...
	public OaiRecord_OaiSet createOaiRecord_OaiSet(long oaiRecordOaiSetId) {
		return oaiRecord_OaiSetPersistence.create(oaiRecordOaiSetId);
	}
	...
	@Override
	public OaiRecord_OaiSet deleteOaiRecord_OaiSet(long oaiRecordOaiSetId)
		throws PortalException {

		return oaiRecord_OaiSetPersistence.remove(oaiRecordOaiSetId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public OaiRecord_OaiSet deleteOaiRecord_OaiSet(
		OaiRecord_OaiSet oaiRecord_OaiSet) {

		return oaiRecord_OaiSetPersistence.remove(oaiRecord_OaiSet);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OaiRecord_OaiSet.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return oaiRecord_OaiSetPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return oaiRecord_OaiSetPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return oaiRecord_OaiSetPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return oaiRecord_OaiSetPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public OaiRecord_OaiSet fetchOaiRecord_OaiSet(long oaiRecordOaiSetId) {
		return oaiRecord_OaiSetPersistence.fetchByPrimaryKey(oaiRecordOaiSetId);
	}
	 ...
	 */
	@Override
	public OaiRecord_OaiSet getOaiRecord_OaiSet(long oaiRecordOaiSetId)
		throws PortalException {

		return oaiRecord_OaiSetPersistence.findByPrimaryKey(oaiRecordOaiSetId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(OaiRecord_OaiSet.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("oaiRecordOaiSetId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(OaiRecord_OaiSet.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return oaiRecord_OaiSetLocalService.deleteOaiRecord_OaiSet(
			(OaiRecord_OaiSet)persistedModel);
	}

	public BasePersistence<OaiRecord_OaiSet> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return oaiRecord_OaiSetPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<OaiRecord_OaiSet> getOaiRecord_OaiSets(int start, int end) {
		return oaiRecord_OaiSetPersistence.findAll(start, end);
	}
	...
	public int getOaiRecord_OaiSetsCount() {
		return oaiRecord_OaiSetPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OaiRecord_OaiSet updateOaiRecord_OaiSet(
		OaiRecord_OaiSet oaiRecord_OaiSet) {
	 ...
	 */
	public OaiRecord_OaiSetLocalService getOaiRecord_OaiSetLocalService() {
	...
	public String getOSGiServiceIdentifier() {
		return OaiRecord_OaiSetLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = oaiRecord_OaiSetPersistence.getDataSource();
	...
	@BeanReference(type = OaiRecord_OaiSetLocalService.class)
	protected OaiRecord_OaiSetLocalService oaiRecord_OaiSetLocalService;
