...
import de.uhh.l2g.plugins.service.OfficeLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.OfficeLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
...
public abstract class OfficeLocalServiceBaseImpl
	...
	implements IdentifiableOSGiService, OfficeLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OfficeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.OfficeLocalServiceUtil</code>.
	 */
	 ...
	 */
	public OfficeLocalService getOfficeLocalService() {
	 ...
	 */
	public void setOfficeLocalService(OfficeLocalService officeLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"de.uhh.l2g.plugins.model.Office", officeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"de.uhh.l2g.plugins.model.Office");
	}
	...
	@BeanReference(type = OfficeLocalService.class)
