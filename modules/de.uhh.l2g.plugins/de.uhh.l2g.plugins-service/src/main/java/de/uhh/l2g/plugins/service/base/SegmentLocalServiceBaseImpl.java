...
/**
 * Provides the base implementation for the segment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.SegmentLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class SegmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, SegmentLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SegmentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.SegmentLocalServiceUtil</code>.
	 */
	...
	public Segment addSegment(Segment segment) {
		...
		return segmentPersistence.update(segment);
	}
	...
	public Segment deleteSegment(Segment segment) {
		return segmentPersistence.remove(segment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Segment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return segmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return segmentPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return segmentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return segmentPersistence.countWithDynamicQuery(
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(segmentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Segment.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("segmentId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Segment.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("segmentId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return segmentLocalService.deleteSegment((Segment)persistedModel);
	}

	public BasePersistence<Segment> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return segmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Segment> getSegments(int start, int end) {
		return segmentPersistence.findAll(start, end);
	}
	...
	public int getSegmentsCount() {
		return segmentPersistence.countAll();
	}
	 ...
	 */
	public SegmentLocalService getSegmentLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"de.uhh.l2g.plugins.model.Segment", segmentLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SegmentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = segmentPersistence.getDataSource();
	...
	@BeanReference(type = SegmentLocalService.class)
	protected SegmentLocalService segmentLocalService;
