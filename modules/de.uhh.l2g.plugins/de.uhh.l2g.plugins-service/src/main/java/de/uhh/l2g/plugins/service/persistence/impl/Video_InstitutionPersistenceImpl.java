...
public class Video_InstitutionPersistenceImpl
	...
	public List<Video_Institution> findByVideo(
		...
		if (useFinderCache) {
			list = (List<Video_Institution>)finderCache.getResult(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_VIDEO_INSTITUTION_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(Video_InstitutionModelImpl.ORDER_BY_JPQL);
			}
	...
	public Video_Institution findByVideo_First(
		...
		throw new NoSuchVideo_InstitutionException(sb.toString());
	}
	...
	protected Video_Institution getByVideo_PrevAndNext(
		...
		List<Video_Institution> list = query.list();
	...
	public int countByVideo(long videoId) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_VIDEO_INSTITUTION_WHERE);
	...
	public List<Video_Institution> findByVideoInstitution(
		...
		return findByVideoInstitution(
			videoId, institutionId, start, end, orderByComparator, true);
	}
	...
	public List<Video_Institution> findByVideoInstitution(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Video_Institution video_Institution : list) {
					if ((videoId != video_Institution.getVideoId()) ||
						(institutionId !=
							video_Institution.getInstitutionId())) {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_VIDEOINSTITUTION_VIDEOID_2);

			sb.append(_FINDER_COLUMN_VIDEOINSTITUTION_INSTITUTIONID_2);
	...
	public List<Video_Institution> findByInstitutionParentId(
		...
		return findByInstitutionParentId(
			institutionParentId, start, end, orderByComparator, true);
	}
	...
	public List<Video_Institution> findByInstitutionParentId(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_INSTITUTIONPARENTID_INSTITUTIONPARENTID_2);
			...
			try {
				...
				queryPos.add(institutionParentId);
	...
	public Video_Institution remove(Serializable primaryKey)
		...
		catch (NoSuchVideo_InstitutionException noSuchEntityException) {
	...
	public List<Video_Institution> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_VIDEO_INSTITUTION);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_VIDEO_INSTITUTION);
