...
/**
 * Provides the base implementation for the metadata local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.MetadataLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 * @see de.uhh.l2g.plugins.service.impl.MetadataLocalServiceImpl
 * @generated
 */
public abstract class MetadataLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, MetadataLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MetadataLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.MetadataLocalServiceUtil</code>.
	 */
	...
	public Metadata createMetadata(long metadataId) {
		return metadataPersistence.create(metadataId);
	}
	...
	@Override
	public Metadata deleteMetadata(long metadataId) throws PortalException {
		return metadataPersistence.remove(metadataId);
	}
	...
	@Override
	public Metadata fetchMetadata(long metadataId) {
		return metadataPersistence.fetchByPrimaryKey(metadataId);
	}
	 ...
	 */
	@Override
	public Metadata getMetadata(long metadataId) throws PortalException {
		return metadataPersistence.findByPrimaryKey(metadataId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(metadataLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Metadata.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("metadataId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Metadata.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("metadataId");
	 ...
	 */
	public MetadataLocalService getMetadataLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"de.uhh.l2g.plugins.model.Metadata", metadataLocalService);
	}
	...
	@BeanReference(type = MetadataLocalService.class)
