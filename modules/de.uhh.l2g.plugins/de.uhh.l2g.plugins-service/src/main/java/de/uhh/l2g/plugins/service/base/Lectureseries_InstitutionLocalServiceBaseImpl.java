...
/**
 * Provides the base implementation for the lectureseries_ institution local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.Lectureseries_InstitutionLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class Lectureseries_InstitutionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, Lectureseries_InstitutionLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>Lectureseries_InstitutionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.Lectureseries_InstitutionLocalServiceUtil</code>.
	 */
	...
	public Lectureseries_Institution addLectureseries_Institution(
		...
		return lectureseries_InstitutionPersistence.update(
	...
	public Lectureseries_Institution createLectureseries_Institution(
		...
		return lectureseries_InstitutionPersistence.create(
	...
	public Lectureseries_Institution deleteLectureseries_Institution(
		...
		return lectureseries_InstitutionPersistence.remove(
			lectureseriesInstitutionId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Lectureseries_Institution.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return lectureseries_InstitutionPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	 ...
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>de.uhh.l2g.plugins.model.impl.Lectureseries_InstitutionModelImpl</code>.
	 * </p>
	 *
	 * @param dynamicQuery the dynamic query
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return lectureseries_InstitutionPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public Lectureseries_Institution fetchLectureseries_Institution(
		...
		return lectureseries_InstitutionPersistence.fetchByPrimaryKey(
			lectureseriesInstitutionId);
	}
	...
	public Lectureseries_Institution getLectureseries_Institution(
		...
		return lectureseries_InstitutionPersistence.findByPrimaryKey(
			lectureseriesInstitutionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(Lectureseries_Institution.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return lectureseries_InstitutionLocalService.
			deleteLectureseries_Institution(
				(Lectureseries_Institution)persistedModel);
	}

	public BasePersistence<Lectureseries_Institution> getBasePersistence() {
	...
	public List<Lectureseries_Institution> getLectureseries_Institutions(
		...
		return lectureseries_InstitutionPersistence.findAll(start, end);
	}
	...
	public int getLectureseries_InstitutionsCount() {
		return lectureseries_InstitutionPersistence.countAll();
	}
	 ...
	 */
	public Lectureseries_InstitutionLocalService
	...
	public String getOSGiServiceIdentifier() {
		return Lectureseries_InstitutionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				lectureseries_InstitutionPersistence.getDataSource();
	...
	@BeanReference(type = Lectureseries_InstitutionLocalService.class)
	protected Lectureseries_InstitutionLocalService
		lectureseries_InstitutionLocalService;
