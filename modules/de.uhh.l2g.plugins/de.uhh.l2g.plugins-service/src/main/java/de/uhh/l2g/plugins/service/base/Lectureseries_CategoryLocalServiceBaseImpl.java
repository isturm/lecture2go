...
public abstract class Lectureseries_CategoryLocalServiceBaseImpl
	...
	implements IdentifiableOSGiService, Lectureseries_CategoryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>Lectureseries_CategoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.Lectureseries_CategoryLocalServiceUtil</code>.
	 */
	...
	public Lectureseries_Category createLectureseries_Category(
		...
		return lectureseries_CategoryPersistence.create(
	...
	public Lectureseries_Category deleteLectureseries_Category(
		...
		return lectureseries_CategoryPersistence.remove(
			lectureseriesCategoryId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Lectureseries_Category.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return lectureseries_CategoryPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return lectureseries_CategoryPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public Lectureseries_Category fetchLectureseries_Category(
		...
		return lectureseries_CategoryPersistence.fetchByPrimaryKey(
			lectureseriesCategoryId);
	}
	...
	public Lectureseries_Category getLectureseries_Category(
		...
		return lectureseries_CategoryPersistence.findByPrimaryKey(
			lectureseriesCategoryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(Lectureseries_Category.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return lectureseries_CategoryLocalService.deleteLectureseries_Category(
			(Lectureseries_Category)persistedModel);
	}

	public BasePersistence<Lectureseries_Category> getBasePersistence() {
	 ...
	 */
	public Lectureseries_CategoryLocalService
	...
	public String getOSGiServiceIdentifier() {
		return Lectureseries_CategoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				lectureseries_CategoryPersistence.getDataSource();
	...
	@BeanReference(type = Lectureseries_CategoryLocalService.class)
	protected Lectureseries_CategoryLocalService
		lectureseries_CategoryLocalService;
