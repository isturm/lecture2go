...
import de.uhh.l2g.plugins.service.SysLocalService;
...
/**
 * Provides the base implementation for the sys local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.SysLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class SysLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, SysLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SysLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.SysLocalServiceUtil</code>.
	 */
	...
	@Override
	public Sys addSys(Sys sys) {
		sys.setNew(true);

		return sysPersistence.update(sys);
	}
	...
	public Sys createSys(int sysId) {
		return sysPersistence.create(sysId);
	}
	...
	@Override
	public Sys deleteSys(int sysId) throws PortalException {
		return sysPersistence.remove(sysId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Sys deleteSys(Sys sys) {
		return sysPersistence.remove(sys);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Sys.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sysPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return sysPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return sysPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sysPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return sysPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Sys fetchSys(int sysId) {
		return sysPersistence.fetchByPrimaryKey(sysId);
	}
	 ...
	 */
	@Override
	public Sys getSys(int sysId) throws PortalException {
		return sysPersistence.findByPrimaryKey(sysId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(sysLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Sys.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(sysLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Sys.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return sysLocalService.deleteSys((Sys)persistedModel);
	}

	public BasePersistence<Sys> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return sysPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Sys> getSyses(int start, int end) {
		return sysPersistence.findAll(start, end);
	}
	...
	public int getSysesCount() {
		return sysPersistence.countAll();
	}
	 ...
	 */
	public SysLocalService getSysLocalService() {
	 ...
	 */
	public void setSysLocalService(SysLocalService sysLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"de.uhh.l2g.plugins.model.Sys", sysLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SysLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = sysPersistence.getDataSource();
	...
	@BeanReference(type = SysLocalService.class)
	protected SysLocalService sysLocalService;
