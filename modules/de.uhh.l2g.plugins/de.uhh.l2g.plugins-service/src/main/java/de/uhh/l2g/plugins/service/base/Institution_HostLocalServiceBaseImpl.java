...
import de.uhh.l2g.plugins.service.Institution_HostLocalService;
...
/**
 * Provides the base implementation for the institution_ host local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.Institution_HostLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class Institution_HostLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, Institution_HostLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>Institution_HostLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.Institution_HostLocalServiceUtil</code>.
	 */
	...
	public Institution_Host addInstitution_Host(
		...
		return institution_HostPersistence.update(institution_Host);
	}
	...
	public Institution_Host createInstitution_Host(long institutionHostId) {
		return institution_HostPersistence.create(institutionHostId);
	}
	...
	public Institution_Host deleteInstitution_Host(long institutionHostId)
		...
		return institution_HostPersistence.remove(institutionHostId);
	}
	...
	public Institution_Host deleteInstitution_Host(
		...
		return institution_HostPersistence.remove(institution_Host);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Institution_Host.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return institution_HostPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return institution_HostPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return institution_HostPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return institution_HostPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Institution_Host fetchInstitution_Host(long institutionHostId) {
		return institution_HostPersistence.fetchByPrimaryKey(institutionHostId);
	}
	...
	public Institution_Host getInstitution_Host(long institutionHostId)
		...
		return institution_HostPersistence.findByPrimaryKey(institutionHostId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(Institution_Host.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("institutionHostId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Institution_Host.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return institution_HostLocalService.deleteInstitution_Host(
			(Institution_Host)persistedModel);
	}

	public BasePersistence<Institution_Host> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return institution_HostPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Institution_Host> getInstitution_Hosts(int start, int end) {
		return institution_HostPersistence.findAll(start, end);
	}
	...
	public int getInstitution_HostsCount() {
		return institution_HostPersistence.countAll();
	}
	 ...
	 */
	public Institution_HostLocalService getInstitution_HostLocalService() {
	...
	public String getOSGiServiceIdentifier() {
		return Institution_HostLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = institution_HostPersistence.getDataSource();
	...
	@BeanReference(type = Institution_HostLocalService.class)
	protected Institution_HostLocalService institution_HostLocalService;
