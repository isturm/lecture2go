...
/**
 * Provides the base implementation for the tagcloud local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.TagcloudLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class TagcloudLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, TagcloudLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TagcloudLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.TagcloudLocalServiceUtil</code>.
	 */
	...
	public Tagcloud addTagcloud(Tagcloud tagcloud) {
		...
		return tagcloudPersistence.update(tagcloud);
	}
	...
	public Tagcloud createTagcloud(long tagcloudId) {
		return tagcloudPersistence.create(tagcloudId);
	}
	...
	public Tagcloud deleteTagcloud(long tagcloudId) throws PortalException {
		return tagcloudPersistence.remove(tagcloudId);
	}
	...
	public Tagcloud deleteTagcloud(Tagcloud tagcloud) {
		return tagcloudPersistence.remove(tagcloud);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Tagcloud.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tagcloudPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return tagcloudPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tagcloudPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return tagcloudPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Tagcloud fetchTagcloud(long tagcloudId) {
		return tagcloudPersistence.fetchByPrimaryKey(tagcloudId);
	}
	...
	public Tagcloud getTagcloud(long tagcloudId) throws PortalException {
		return tagcloudPersistence.findByPrimaryKey(tagcloudId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(tagcloudLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Tagcloud.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("tagcloudId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Tagcloud.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("tagcloudId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return tagcloudLocalService.deleteTagcloud((Tagcloud)persistedModel);
	}

	public BasePersistence<Tagcloud> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return tagcloudPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Tagcloud> getTagclouds(int start, int end) {
		return tagcloudPersistence.findAll(start, end);
	}
	...
	public int getTagcloudsCount() {
		return tagcloudPersistence.countAll();
	}
	 ...
	 */
	public TagcloudLocalService getTagcloudLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"de.uhh.l2g.plugins.model.Tagcloud", tagcloudLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TagcloudLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = tagcloudPersistence.getDataSource();
	...
	@BeanReference(type = TagcloudLocalService.class)
	protected TagcloudLocalService tagcloudLocalService;
