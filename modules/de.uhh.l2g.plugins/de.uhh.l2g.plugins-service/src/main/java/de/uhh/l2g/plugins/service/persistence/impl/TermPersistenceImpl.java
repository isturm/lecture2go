...
public class TermPersistenceImpl
	...
	public List<Term> findByPrefix(
		...
		return findByPrefix(prefix, start, end, orderByComparator);
	}
	...
	public List<Term> findByPrefix(
		...
		List<Term> list = (List<Term>)finderCache.getResult(
	...
	public List<Term> findByYear(
		...
		return findByYear(year, start, end, orderByComparator);
	}
	...
	public List<Term> findByPrefixAndYear(
		...
		return findByPrefixAndYear(prefix, year, start, end, orderByComparator);
	}
