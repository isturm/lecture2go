 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.Producer_LectureseriesLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class Producer_LectureseriesLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, Producer_LectureseriesLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>Producer_LectureseriesLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.Producer_LectureseriesLocalServiceUtil</code>.
	 */
	...
	public Producer_Lectureseries addProducer_Lectureseries(
		...
		return producer_LectureseriesPersistence.update(producer_Lectureseries);
	}
	...
	public Producer_Lectureseries createProducer_Lectureseries(
		...
		return producer_LectureseriesPersistence.create(
	...
	public Producer_Lectureseries deleteProducer_Lectureseries(
		...
		return producer_LectureseriesPersistence.remove(
			producerLectureseriesId);
	}
	...
	public Producer_Lectureseries deleteProducer_Lectureseries(
		...
		return producer_LectureseriesPersistence.remove(producer_Lectureseries);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Producer_Lectureseries.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return producer_LectureseriesPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return producer_LectureseriesPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public Producer_Lectureseries fetchProducer_Lectureseries(
		...
		return producer_LectureseriesPersistence.fetchByPrimaryKey(
			producerLectureseriesId);
	}
	...
	public Producer_Lectureseries getProducer_Lectureseries(
		...
		return producer_LectureseriesPersistence.findByPrimaryKey(
			producerLectureseriesId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(Producer_Lectureseries.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return producer_LectureseriesLocalService.deleteProducer_Lectureseries(
			(Producer_Lectureseries)persistedModel);
	}

	public BasePersistence<Producer_Lectureseries> getBasePersistence() {
	...
	public List<Producer_Lectureseries> getProducer_Lectureserieses(
		...
		return producer_LectureseriesPersistence.findAll(start, end);
	}
	...
	public int getProducer_LectureseriesesCount() {
		return producer_LectureseriesPersistence.countAll();
	}
	 ...
	 */
	public Producer_LectureseriesLocalService
	...
	public String getOSGiServiceIdentifier() {
		return Producer_LectureseriesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				producer_LectureseriesPersistence.getDataSource();
	...
	@BeanReference(type = Producer_LectureseriesLocalService.class)
	protected Producer_LectureseriesLocalService
		producer_LectureseriesLocalService;
