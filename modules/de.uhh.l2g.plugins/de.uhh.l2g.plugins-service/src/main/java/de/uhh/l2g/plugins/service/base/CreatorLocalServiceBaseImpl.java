...
/**
 * Provides the base implementation for the creator local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.CreatorLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class CreatorLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements CreatorLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CreatorLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.CreatorLocalServiceUtil</code>.
	 */
	...
	public Creator addCreator(Creator creator) {
		...
		return creatorPersistence.update(creator);
	}
	...
	public Creator createCreator(long creatorId) {
		return creatorPersistence.create(creatorId);
	}
	...
	public Creator deleteCreator(long creatorId) throws PortalException {
		return creatorPersistence.remove(creatorId);
	}
	...
	public Creator deleteCreator(Creator creator) {
		return creatorPersistence.remove(creator);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Creator.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return creatorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return creatorPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return creatorPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return creatorPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Creator fetchCreator(long creatorId) {
		return creatorPersistence.fetchByPrimaryKey(creatorId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(creatorLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Creator.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("creatorId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Creator.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("creatorId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return creatorLocalService.deleteCreator((Creator)persistedModel);
	}

	public BasePersistence<Creator> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return creatorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Creator> getCreators(int start, int end) {
		return creatorPersistence.findAll(start, end);
	}
	...
	public int getCreatorsCount() {
		return creatorPersistence.countAll();
	}
	 ...
	 */
	public CreatorLocalService getCreatorLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"de.uhh.l2g.plugins.model.Creator", creatorLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CreatorLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = creatorPersistence.getDataSource();
	...
	@BeanReference(type = CreatorLocalService.class)
	protected CreatorLocalService creatorLocalService;
