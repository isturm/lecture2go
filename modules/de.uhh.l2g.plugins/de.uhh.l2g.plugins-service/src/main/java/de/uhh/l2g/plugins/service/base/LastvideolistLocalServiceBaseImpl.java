...
/**
 * Provides the base implementation for the lastvideolist local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.LastvideolistLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class LastvideolistLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, LastvideolistLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LastvideolistLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.LastvideolistLocalServiceUtil</code>.
	 */
	...
	@Override
	public Lastvideolist addLastvideolist(Lastvideolist lastvideolist) {
	...
	public Lastvideolist deleteLastvideolist(Lastvideolist lastvideolist) {
		return lastvideolistPersistence.remove(lastvideolist);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Lastvideolist.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return lastvideolistPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return lastvideolistPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return lastvideolistPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return lastvideolistPersistence.countWithDynamicQuery(
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(lastvideolistLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Lastvideolist.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("lastvideolistId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Lastvideolist.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return lastvideolistLocalService.deleteLastvideolist(
			(Lastvideolist)persistedModel);
	}

	public BasePersistence<Lastvideolist> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return lastvideolistPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Lastvideolist> getLastvideolists(int start, int end) {
		return lastvideolistPersistence.findAll(start, end);
	}
	...
	public int getLastvideolistsCount() {
		return lastvideolistPersistence.countAll();
	}
	 ...
	 */
	public LastvideolistLocalService getLastvideolistLocalService() {
	...
	public String getOSGiServiceIdentifier() {
		return LastvideolistLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = lastvideolistPersistence.getDataSource();
	...
	@BeanReference(type = LastvideolistLocalService.class)
	protected LastvideolistLocalService lastvideolistLocalService;
