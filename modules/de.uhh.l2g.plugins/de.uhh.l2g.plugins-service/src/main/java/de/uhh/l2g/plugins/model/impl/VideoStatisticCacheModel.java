...
public class VideoStatisticCacheModel implements CacheModel<VideoStatistic>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof VideoStatisticCacheModel)) {
			return false;
		}

		VideoStatisticCacheModel videoStatisticCacheModel = (VideoStatisticCacheModel)obj;

		if (videoStatisticId == videoStatisticCacheModel.videoStatisticId) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, videoStatisticId);
	}
