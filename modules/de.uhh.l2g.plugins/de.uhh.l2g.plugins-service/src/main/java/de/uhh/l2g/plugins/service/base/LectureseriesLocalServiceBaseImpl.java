...
/**
 * Provides the base implementation for the lectureseries local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.LectureseriesLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class LectureseriesLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, LectureseriesLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LectureseriesLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.uhh.l2g.plugins.service.LectureseriesLocalServiceUtil</code>.
	 */
	...
	public Lectureseries addLectureseries(Lectureseries lectureseries) {
		...
		return lectureseriesPersistence.update(lectureseries);
	}
	...
	public Lectureseries createLectureseries(long lectureseriesId) {
		return lectureseriesPersistence.create(lectureseriesId);
	}
	...
	public Lectureseries deleteLectureseries(long lectureseriesId)
		...
		return lectureseriesPersistence.remove(lectureseriesId);
	}
	...
	public Lectureseries deleteLectureseries(Lectureseries lectureseries) {
		return lectureseriesPersistence.remove(lectureseries);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Lectureseries.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return lectureseriesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return lectureseriesPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return lectureseriesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return lectureseriesPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Lectureseries fetchLectureseries(long lectureseriesId) {
		return lectureseriesPersistence.fetchByPrimaryKey(lectureseriesId);
	}
	...
	public Lectureseries getLectureseries(long lectureseriesId)
		...
		return lectureseriesPersistence.findByPrimaryKey(lectureseriesId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(lectureseriesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Lectureseries.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("lectureseriesId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Lectureseries.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return lectureseriesLocalService.deleteLectureseries(
			(Lectureseries)persistedModel);
	}

	public BasePersistence<Lectureseries> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return lectureseriesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Lectureseries> getLectureserieses(int start, int end) {
		return lectureseriesPersistence.findAll(start, end);
	}
	...
	public int getLectureseriesesCount() {
		return lectureseriesPersistence.countAll();
	}
	 ...
	 */
	public LectureseriesLocalService getLectureseriesLocalService() {
	...
	public String getOSGiServiceIdentifier() {
		return LectureseriesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = lectureseriesPersistence.getDataSource();
	...
	@BeanReference(type = LectureseriesLocalService.class)
	protected LectureseriesLocalService lectureseriesLocalService;
