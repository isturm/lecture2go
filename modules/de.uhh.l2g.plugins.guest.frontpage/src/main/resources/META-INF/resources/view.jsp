...
<div class="front-page-teaser">
	<div class="bg-video-container">
		<video id="bg-vid" loop
			poster="/o/de.uhh.l2g.themes.uhhci/images/background_still.jpg"
			preload="none" muted>
			<!-- the video source is added dynamically to avoid unnecessary traffic -->
			<img src="/o/de.uhh.l2g.themes.uhhci/images/background_still.jpg" alt="Background image">
		</video>
	...
	<div class="l2go-info-container">
		<div class="l2go-info">
			...
			<button id="outer-catalogue-button" class="catalogue-button"
				onclick="window.location='/web/vod/l2go';">
				<liferay-ui:message key="to-catalogue" />
			</button>
		</div>
	</div>
</div>
...
<div id="front-page-content">
	...
	<!-- latest videos -->
	<h2>
		<liferay-ui:message key="last-added" />
	</h2>
	<div id="news-carousel" class="carousel slide" data-ride="carousel">
					...
					<c:forEach items="${latest}" var="item">
						...
						<c:choose>
							...
							<c:otherwise>
								...
								<c:set var="itemLatestOpenAccessVideoId"
									value="${item.latestOpenAccessVideoId}" />
								<c:set var="vid"
									value="<%=VideoLocalServiceUtil
								.getVideo((Long) pageContext.getAttribute("itemLatestOpenAccessVideoId"))%>" />
								<c:set var="isVideo" value="true" />
							</c:otherwise>
						</c:choose>
		...
		<div class="row-fluid video-box-list">
					...
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 video-box"
						...
						<div class="video-box-content">
								<div class="row video-label">
								 <c:set var="vidVideoId" value="${vid.videoId}" />
									<c:set var="vi"
										value="<%=Video_InstitutionLocalServiceUtil.getByVideo((Long) pageContext.getAttribute("vidVideoId"))%>" />
									<!-- only get the first institution --> <c:set
										var="viInstitutionId" value="${vi[0].institutionId}" /> <c:if
										test="${viInstitutionId>0}">
										<c:set var="inst"
							...
							<div
								class="creator-small2 dot-ellipsis dot-height-25 dot-resize-update ">${vid.linkedCreators}</div>
							<div
								class="lectureseries-small dot-ellipsis dot-height-25 dot-resize-update">
								<c:choose>
									<c:when test="${!isVideo}">
		...
		<a class="carousel-control-prev" href="#news-carousel" role="button"
			data-slide="prev"> <span class="carousel-control-prev-icon"
			aria-hidden="true"></span> <span class="sr-only">Previous</span>
		</a> <a class="carousel-control-next" href="#news-carousel" role="button"
	...
	<div id="popular-carousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			...
			<a class="carousel-control-prev" href="#popular-carousel"
				role="button" data-slide="prev"> <span
				class="carousel-control-prev-icon" aria-hidden="true"></span> <span
				class="sr-only">Previous</span>
			</a> <a class="carousel-control-next" href="#popular-carousel"
