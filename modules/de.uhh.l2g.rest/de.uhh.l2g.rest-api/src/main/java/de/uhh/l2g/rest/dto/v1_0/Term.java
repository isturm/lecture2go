...
public class Term {
	...
	@Schema(description = "Term ID of the term.")
	...
	@Schema(description = "Name of the term.")
	...
	public void setTermName(
		UnsafeSupplier<String, Exception> termNameUnsafeSupplier) {

		try {
			termName = termNameUnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
