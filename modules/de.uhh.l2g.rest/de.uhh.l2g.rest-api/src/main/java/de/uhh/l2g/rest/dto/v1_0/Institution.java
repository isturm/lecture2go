...
public class Institution {
	...
	public void setInstitutionName(
		UnsafeSupplier<String, Exception> institutionNameUnsafeSupplier) {

		try {
			institutionName = institutionNameUnsafeSupplier.get();
		}
	...
	public boolean equals(Object object) {
		...
		return Objects.equals(toString(), institution.toString());
	}
	...
	public String toString() {
		...
		if (institutionName != null) {
			...
			sb.append(_escape(institutionName));
