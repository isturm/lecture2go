...
@Component(immediate = true, property = { "com.liferay.portlet.display-category=lecture2go.plugins",
		...
		"javax.portlet.display-name=EmbedVideo", "javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp", "javax.portlet.name=" + EmbedVideoPortletKeys.EMBEDVIDEO,
...
public class EmbedVideoPortlet extends MVCPortlet {
	...
	public void render(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		try {
			...
			Video video = VideoLocalServiceUtil.getCurrentlyValidVideo(videoId);
