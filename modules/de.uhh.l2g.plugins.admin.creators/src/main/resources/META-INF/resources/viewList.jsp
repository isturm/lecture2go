...
<div class="creators-view">
    ...
    <div class="d-flex flex-row-reverse">
        ...
        <div class="col-8 edit-table">
            <a href="${addURL}" class="add-link">
                <span class="icon-plus"></span> <liferay-ui:message key="add-new-creator"/>
            </a>
            ...
            <liferay-ui:search-container-row className="de.uhh.l2g.plugins.model.Creator"
                                             keyProperty="creatorId"
                                             modelVar="creator">
                ...
                <liferay-ui:search-container-column-text>
                    ...
                    <div class="video-creators">
                        <c:forEach items="${videoCreators}" var="vidcr" varStatus="status">
                            ...
                            <c:set var="video"
                                   value="<%=VideoLocalServiceUtil.getVideo((Long)pageContext.getAttribute("vId"))%>"/>
