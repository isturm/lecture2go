...
<c:set var="displayTerms" value="<%=new DisplayTerms(renderRequest)%>"/>
    ...
    <aui:form action="${categoriesSearchURL}" method="post" name="fm">
        ...
        <liferay-ui:search-container emptyResultsMessage="no-categories-found" delta="5" iteratorURL="${portletURL}"
            ...
            <a href="${addURL}" class="add-link">
                <span class="icon-large icon-plus"></span> <liferay-ui:message key="add-new-category"/>
            </a>
            ...
            <liferay-ui:search-container-row className="de.uhh.l2g.plugins.model.Category" keyProperty="categoryId"
                                             modelVar="category">
                <%
