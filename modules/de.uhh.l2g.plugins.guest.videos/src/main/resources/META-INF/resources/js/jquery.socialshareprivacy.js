    ...
    $.fn.socialSharePrivacy = function (settings) {
        var defaults = {
            'services' : {
                'facebook' : {
                    'status'            : 'on',
                    'dummy_img'         : '/o/de.uhh.l2g.themes.uhhci/images/dummy_facebook.png',
                ...
                'twitter' : {
                    'status'            : 'on', 
                    'dummy_img'         : '/o/de.uhh.l2g.themes.uhhci/images/dummy_twitter.png',
                ...
                'gplus' : {
                    'status'            : 'on',
                    'dummy_img'         : '/o/de.uhh.l2g.themes.uhhci/images/dummy_gplus.png',
            ...
            'settings_perma'    : 'Durationhaft aktivieren und Daten&uuml;ber&shy;tragung zustimmen:',
            'cookie_path'       : '/',
            'cookie_domain'     : document.location.host,
            'cookie_expires'    : '365',
            'css_path'          : '/o/de.uhh.l2g.themes.uhhci/css/main.css',
            'uri'               : getURI
        };
...
/*            
            ...
            // Menue zum durationhaften Einblenden der aktiven Dienste via Cookie einbinden
            ...
            if (((facebook_on && facebook_perma)
                ...
                // Klick-Interaktion auf <input> um Dienste durationhaft ein- oder auszuschalten (Cookie wird gesetzt oder geloescht)
