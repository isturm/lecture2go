...
<div class="view table">
    <div class="col-12">
        <a href="${addURL}" class="add-link">
            <span class="icon-large icon-plus"></span> <liferay-ui:message key="add-new-term"/>
        </a>
        ...
        <liferay-ui:search-container emptyResultsMessage="no-terms-found" delta="10" iteratorURL="${portletURL}"
            ...
            <liferay-ui:search-container-row className="de.uhh.l2g.plugins.model.Term" keyProperty="termId"
                                             modelVar="term">
                <%
